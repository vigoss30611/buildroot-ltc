...
struct mtd_blktrans_ops {
	...
	void (*erase_data)(struct mtd_blktrans_dev *dev, unsigned int cmd, unsigned long arg);	
	int (*init_bounce_buf)(struct mtd_blktrans_dev *dev, struct request_queue *rq);	
	...
	int (*read_multisect)(struct mtd_blktrans_dev *dev,
		    unsigned long block, unsigned long nblock, char *buffer);

...
enum clk_type {
	osc, apll, dpll, epll, vpll, gtm, cpu, smp_twd, bus1, bus2, bus3,
	bus4, bus5, bus6, bus7, ids0_eitf, ids0_ods, ids0_tvif, ids1_eitf,
	...
	camo, ddr_phy, sd_mmc3, acodec, sysbus, apb_pclk, ids0, dsi, ids1,
	hdmi_tx, gpu, usb_ohci, usb_ehci, usb_otg, sdmmc0, sdmmc1, sdmmc2,
	sdmmc3, nandflash, vdec, isp, eth, mipi_csi, venc, iis, pcm0, pcm1,
	spdif_core, audiocodec, gpio, dma, cpu_core, rtc, sysm, ps2_0, ps2_1,
	pwm0, pwm1, pwm2, pwm3, pwm4, i2c0, i2c1, i2c2, i2c3, spi0, spi1,
	spi2, watch_dog, cmn_timer0, cmn_timer1, clk_max
};

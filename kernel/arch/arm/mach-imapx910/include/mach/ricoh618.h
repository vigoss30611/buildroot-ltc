...
#define RICOH_ERR_FLAG		1
#define RICOH_INFO_FLAG		1
#define RICOH_DEBUG_FLAG	1

#if RICOH_ERR_FLAG
#define RICOH_ERR(format, args...)  printk(KERN_ERR "[RICOH]"format, ##args)
#else
#define RICOH_ERR(format, args...)  do {} while (0)
#endif

#if RICOH_INFO_FLAG
#define RICOH_INFO(format, args...)  printk(KERN_INFO "[RICOH]"format, ##args)
#else
#define RICOH_INFO(format, args...)  do {} while (0)
#endif

#if RICOH_DEBUG_FLAG
#define RICOH_DBG(format, args...)  printk(KERN_DEBUG "[RICOH]"format, ##args)
#else

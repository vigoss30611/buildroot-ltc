/* arch/arm/mach-apollo3/power-gate.c
 *
...
//	__pow_writel( __pow_readl(SYS_SYNCRST_CLK_EN(module_addr)) & (~(1 << 7)), SYS_SYNCRST_CLK_EN(module_addr));
	...
	/*for apollo3, This Bit ctrl Iram for post*/
...
void apollo3_reset_core(int index, uint32_t hold_base)
{
	uint32_t tmp;                                        
...
void apollo3_reset_module(void)
{

...
#define IMAP_LCDCON6		IMAP_LCDREG(0x0018)	/* LCD Control 5 Register */
...
#define IMAP_OVCW0VSSR		IMAP_LCDREG(0x108C)	/* Overlay Controller Window 0 Virtual Screen Size Register */
#define IMAP_OVCW0CMR		IMAP_LCDREG(0x1090)	/* Overlay Controller Window 0 Color Map Register */
#define IMAP_OVCW0B0SAR	IMAP_LCDREG(0x1094)	/* Overlay Controller Window 0 Buffer 0 Start Address Register */
#define IMAP_OVCW0B1SAR	IMAP_LCDREG(0x1098)	/* Overlay Controller Window 0 Buffer 1 Start Address Register */
...
//LCDCON2
#define IMAP_LCDCON2_VBPD_MSK		(~(0x7ff<<16))
#define IMAP_LCDCON2_VBPD(x)		(((x)&0x7ff)<<16)
#define IMAP_LCDCON2_VFPD_MSK		(~(0x7ff<<0))
#define IMAP_LCDCON2_VFPD(x)		(((x)&0x7ff)<<0)
//LCDCON3
#define IMAP_LCDCON3_VSPW_MSK		(~(0x7ff<<16))
#define IMAP_LCDCON3_VSPW(x)		(((x)&0x7ff)<<16)
#define IMAP_LCDCON3_HSPW_MSK	(~(0x7ff<<0))
#define IMAP_LCDCON3_HSPW(x)		(((x)&0x7ff)<<0)
//LCDCON4
#define IMAP_LCDCON4_HBPD_MSK		(~(0x7ff<<16))
#define IMAP_LCDCON4_HBPD(x)		(((x)&0x7ff)<<16)
#define IMAP_LCDCON4_HFPD_MSK		(~(0x7ff<<0))
#define IMAP_LCDCON4_HFPD(x)		(((x)&0x7ff)<<0)
//LCDCON5
...
//LCDCON6
#define IMAP_LCDCON6_LINEVAL_MSK		(~(0x7ff) << 16)
#define IMAP_LCDCON6_LINEVAL(x)			(((x)&0x7ff) << 16)
#define IMAP_LCDCON6_HOZVAL_MSK			(~(0x7ff<<0))
#define IMAP_LCDCON6_HOZVAL(x)			(((x)&0x7ff)<<0)

//OVCDCR
#define IMAP_OVCDCR_UPDATEREG_DISABLE	(0x0<<11)
#define IMAP_OVCDCR_UPDATEREG_ENABLE		(0x1<<11)
...
//OVCWxPCAR
#define IMAP_OVCWxPCAR_LEFTTOPX_MSK		(~(0x7ff<<0))
#define IMAP_OVCWxPCAR_LEFTTOPX(x)		(((x)&0x7ff)<<0)
#define IMAP_OVCWxPCAR_LEFTTOPY_MSK		(~(0x7ff<<16))
#define IMAP_OVCWxPCAR_LEFTTOPY(x)		(((x)&0x7ff)<<16)
//OVCWxPCBR
#define IMAP_OVCWxPCBR_RIGHTBOTX_MSK	(~(0x7ff<<0))
#define IMAP_OVCWxPCBR_RIGHTBOTX(x)		(((x)&0x7ff)<<0)
#define IMAP_OVCWxPCBR_RIGHTBOTY_MSK	(~(0x7ff<<16))
#define IMAP_OVCWxPCBR_RIGHTBOTY(x)		(((x)&0x7ff)<<16)
//OVCWxPCCR

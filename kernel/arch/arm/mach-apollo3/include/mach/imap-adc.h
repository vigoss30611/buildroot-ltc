...
#define TSC_PPOUT(chn)		(chn < 11 ? TSC_PPOUT_0 + 0x4 * chn : TSC_PPOUT_0 + 0x4 * (chn + 1))
#define TSC_IRQ_PAR(chn)   (chn > 4 ? TSC_INT_PAR5 + (0x4 * (chn - 5)) : (chn > 0 ? TSC_INT_PAR1 + 0x4 * (chn - 1): TSC_PP_PAR))

...
extern int imapx_fr1023_init(char *codec_name,
        char *cpu_dai_name, enum data_mode data, int enable, int id);
#endif
...
extern int imapx_ip6205_init(char *codec_name,
		char *cpu_dai_name, enum data_mode data, int enable, int id);
#endif
#ifdef CONFIG_SND_IMAPX_SOC_IP2906
extern int imapx_ip2906_init(char *codec_name,
		char *cpu_dai_name, enum data_mode data, int enable, int id);
#endif
extern int imapx_bt_init(char *codec_name, 
		char *cpu_dai_name, enum data_mode data, int enable, int id);		

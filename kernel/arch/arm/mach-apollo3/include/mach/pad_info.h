...
struct pad_init_info cam1_pads_info[] = {
	PAD_INIT("disp0",	"cam1",	0,	0, "function",	"down", 1,  	0),
	PAD_INIT("disp1",	"cam1",	1,	0, "function",	"down", 1,	0),
	PAD_INIT("disp2",	"cam1",	2,	0, "function",	"down", 1,	0),
	PAD_INIT("disp3",	"cam1",	3,	0, "function",	"down", 1,	0),
	PAD_INIT("disp4",	"cam1",	4,	0, "function",	"down", 1,	0),
	PAD_INIT("disp5",	"cam1",	5,	0, "function",	"down", 1,	0),
	PAD_INIT("disp6",	"cam1",	6,	0, "function",	"down", 1,	0),
	PAD_INIT("disp7",	"cam1",	7,	0, "function",	"down", 1,	0),
	PAD_INIT("disp8",	"cam1",	8,	0, "function",	"down", 1,	0),
	PAD_INIT("disp9",	"cam1",	9,	0, "function",	"down", 1,	0),
	PAD_INIT("disp10",	"cam1",	10,	0, "function",	"down", 1,	0),
	PAD_INIT("disp20",	"cam1",	20,	1, "function",	"down", 1,	0),
	PAD_INIT("disp21",	"cam1",	21,	1, "function",	"down", 1,	0),
	PAD_INIT("disp22",	"cam1",	22,	1, "function",	"down", 1,	0),
	PAD_INIT("disp27",	"cam1",	27,	1, "function",	"down", 1,	0),
};

struct pad_init_info pwm2mux_pads_info[] = {
	PAD_INIT("disp23",	"pwm2-mux",	23,	1, "function",	"down", 1,	0),
};

struct pad_init_info pwm3mux_pads_info[] = {
	PAD_INIT("disp24",	"pwm3-mux",	24,	1, "function",	"down", 1,	0),
};

struct pad_init_info iic4mux_pads_info[] = {
	PAD_INIT("disp25",	"iic4-mux",	25,	1, "function",	"down", 1,	0),
	PAD_INIT("disp26",	"iic4-mux",	26,	1, "function",	"down", 1,	0),
};
...
struct pad_init_info  pcm0mux_pads_info[] = {
	PAD_INIT("comd0",	"pcm0-mux",	47,	2, "function",	"up", 1,	0),
	PAD_INIT("comd1",	"pcm0-mux",	48,	3, "function",	"up", 1,	0),
	PAD_INIT("comd2",	"pcm0-mux",	49,	3, "function",	"up", 1,	0),
	PAD_INIT("comd3",	"pcm0-mux",	50,	3, "function",	"up", 1,	0),
	PAD_INIT("comd4",	"pcm0-mux", 	51,	3, "function",	"up", 1,	0),
};
...
struct pad_init_info cam1mux_pads_info[] = {
	PAD_INIT("comd5",	"cam1-mux",    52,	3, "function",	"down", 1,	0),
	PAD_INIT("comd6",	"cam1-mux",    53,	3, "function",	"down", 1,	0),
	PAD_INIT("comd7",	"cam1-mux",    54,	3, "function",	"down", 1,	0),
	PAD_INIT("comd8",	"cam1-mux",    55,	3, "function",	"down", 1,	0),
	PAD_INIT("comd9",	"cam1-mux",    56,	3, "function",	"down", 1,	0),
	PAD_INIT("comd10",	"cam1-mux",	57,	3, "function",	"down", 1,	0),
	PAD_INIT("comd11",	"cam1-mux",	58,	3, "function",	"down", 1,	0),
	PAD_INIT("comd12",	"cam1-mux",	59,	3, "function",	"down", 1,	0),
	PAD_INIT("comd13",	"cam1-mux",	60,	3, "function",	"down", 1,	0),
	PAD_INIT("comd14",	"cam1-mux",	61,	3, "function",	"down", 1,	0),
	PAD_INIT("comd15",	"cam1-mux",	62,	3, "function",	"down", 1,	0),
	PAD_INIT("comd16",	"cam1-mux",	63,	3, "function",	"down", 1,	0),
	PAD_INIT("comd17",	"cam1-mux",	64,	4, "function",	"down", 1,	0),
	PAD_INIT("comd18",	"cam1-mux",	65,	4, "function",	"down", 1,	0),
};
...
struct pad_init_info  pwm2_pads_info[] = {
	PAD_INIT("comd72",	"pwm2",	119,	7, "function",	"up", 1,	0),
};

struct pad_init_info  pwm3_pads_info[] = {
	PAD_INIT("comd73",	"pwm3",	120,	7, "function",	"down", 1,	0),
};

struct pad_init_info pwm4_pads_info[] = {
	PAD_INIT("comd74",	"pwm4",	121,	7, "function",	"down", 1,	0),
};

struct pad_init_info pwm5_pads_info[] = {
	PAD_INIT("comd75",	"pwm5",	122,	7, "function",	"down", 1,	0),
};

struct pad_init_info pwm6_pads_info[] = {
	PAD_INIT("comd76",	"pwm6",	123,	7, "function",	"down", 1,	0),
};

struct pad_init_info pwm7_pads_info[] = {
	PAD_INIT("comd77",	"pwm7",	124,	7, "function",	"down", 1,	0),
};
...
struct module_mux_info imapx_module_mux1_info[] = {
	MODULE_MUX("iis0",	0,	0),
	MODULE_MUX("pcm0-mux",	0,	1),
	MODULE_MUX("rgb0",	1,	0),
	MODULE_MUX("pwm2-mux",	1,	1),
	MODULE_MUX("pwm3-mux",	1,	1),
	MODULE_MUX("rgb0",	5,	0),
	MODULE_MUX("iic4-mux",	5,	1),
	MODULE_MUX("rgb0",	6,	0),
	MODULE_MUX("cam1",	6,	1),
	MODULE_MUX("pcm0",	7,	0),
	MODULE_MUX("phy",	7,	0),
	MODULE_MUX("cam1-mux",	7,	1),
};
...
struct module_pads_info imapx_module_pads_info[] = {
	...
	MODULE_PADS("cam1-mux", 	cam1mux_pads_info,	ARRAY_SIZE(cam1mux_pads_info)),
	MODULE_PADS("pwm2-mux", 	pwm2mux_pads_info,	ARRAY_SIZE(pwm2mux_pads_info)),
	MODULE_PADS("pwm3-mux", 	pwm3mux_pads_info,	ARRAY_SIZE(pwm3mux_pads_info)),
	MODULE_PADS("iic4-mux", 	iic4mux_pads_info,	ARRAY_SIZE(iic4mux_pads_info)),
}; 

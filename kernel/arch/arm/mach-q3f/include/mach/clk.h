...
enum clk_type {
	osc, apll, dpll, epll, vpll, gtm, cpu, apb_pclk, bus1, bus3,
	bus4, bus6, ids0_eitf, ids0_ods, mipi_dphy_con ,
	sd_mmc2, sd_mmc1, sd_mmc0, uart, ssp_clk,
	audio_clk, usb_ref, camo, clk_out1, mipi_dphy_pixel,  ddr_phy, crypto, touchscreen, 
	apb_output, venc264,  isp, camif, mipi_csi, ids0,
	hdmi_tx, crypto_dma, fodet, ispost,  venc264_ctrl,
 	usb_ohci, usb_ehci, usb_otg, sdmmc0, sdmmc1, sdmmc2, dma, eth,
   	iis, cmn_timer0, cmn_timer1, pwm0, pwm1, pwm2, pwm3, pwm4, i2c0, i2c1, i2c2,
	i2c3, pcm0, spi0, spi1, uart_core, audiocodec, tsc_ctrl, gpio, watch_dog, clk_max
};

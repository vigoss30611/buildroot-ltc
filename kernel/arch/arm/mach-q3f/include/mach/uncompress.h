...
#define Q3F_SYSMGR_PAD_BASE	0x2d009000
...
static void gpio_func_mode(int io_index)
{
    ...
    cnt = io_index/8;
    num = io_index&0x7;
    val = __raw_readl(Q3F_SYSMGR_PAD_BASE + 0x64 + cnt*4);
    val &=~(1<<num);
    __raw_writel(val, Q3F_SYSMGR_PAD_BASE + 0x64 + cnt*4);
}
...
static inline void arch_decomp_setup(void)
{
	...
	int32_t ibr, fbr;
#if defined(CONFIG_Q3F_FPGA_PLATFORM)

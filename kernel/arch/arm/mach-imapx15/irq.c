...
static struct imapx820_irq_desc imapx_irq[] = {
	...
	IMAPX_IRQ_DISPATCH_DESC(GIC_IIC4_ID, CPU1),
	IMAPX_IRQ_DISPATCH_DESC(GIC_IIC5_ID, CPU1),
#ifdef CONFIG_MTD_INFOTM_NAND
	IMAPX_IRQ_DISPATCH_DESC(GIC_NAND_ID, CPU1),
#endif
#ifdef CONFIG_SERIAL_AMBA_PL011
	IMAPX_IRQ_DISPATCH_DESC(GIC_UART0_ID, CPU1),
	IMAPX_IRQ_DISPATCH_DESC(GIC_UART1_ID, CPU1),
	IMAPX_IRQ_DISPATCH_DESC(GIC_UART2_ID, CPU1),
	IMAPX_IRQ_DISPATCH_DESC(GIC_UART3_ID, CPU1),
#endif
#ifdef CONFIG_INFOTM_GPS
	IMAPX_IRQ_DISPATCH_DESC(GIC_GPSACQ_ID, CPU1),
	IMAPX_IRQ_DISPATCH_DESC(GIC_GPSTCK_ID, CPU1),
#endif

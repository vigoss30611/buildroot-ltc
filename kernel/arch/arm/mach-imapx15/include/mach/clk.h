...
#define IMAP_OSC_CLK	12000000

#define DEFAULT_RATE	0

enum clk_type {
	osc, apll, dpll, epll, vpll, gtm, cpu, smp_twd, apb_pclk, bus1, bus2,
	bus3, bus4, bus5, bus6, bus7, ids0_eitf, ids0_ods, ids0_tvif, ids1_eitf,
	ids1_ods, ids1_tvif, mipi_dphy_con, mipi_dphy_ref, mipi_dphy_pixel,
	isp_osd, sd_mmc0, sd_mmc1, sd_mmc2, nand_ecc, hdmi, uart0, uart1,
	uart2, uart3, spdif, audio_clk, usb_ref, clk_out0, clk_out1, sata_phy,
	camo, ddr_phy, crypto, touchscreen, dmic, ids0, ids1, gpu, vdec, venc,
	isp, mipi_csi, tsif, usb_ohci, usb_ehci, usb_otg, sdmmc0, sdmmc1, sdmmc2,
	nandflash, sata, eth, iis, pcm0, pcm1, spdif_core, gpio, dma, cpu_core,
	rtc, sysm, ps2_0, ps2_1, pwm0, pwm1, pwm2, pwm3, pwm4, i2c0, i2c1, i2c2,
	i2c3, spi0, spi1, spi2, watch_dog, cmn_timer0, cmn_timer1, simc0, simc1,
	keyboard, uart_core, clk_max
};
...
#define CLK_INIT_CONF(_type, _rate, _state) \
{\
	.type = _type,				\
	.rate = _rate,				\
	.state = _state,			\
...
#define APLL_SRC_STATUS              (0x008)
#define APLL_LOAD_AND_GATE           (0x00c)
#define APLL_LOCKED_STATUS           (0x014)
#define APLL_ENABLE                  (0x010)

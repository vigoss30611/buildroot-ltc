...
#define GIC_IIC5_ID		(47)
#define GIC_PCM0_ID		(48)
#define GIC_SSP0_ID		(195)
...
#define GIC_MMC1_ID     (205)
#define GIC_MMC2_ID     (206)
...
#define IMAP_GIC_CPU_BASE	(0x18000000 + 0x2000)		
#define IMAP_GIC_DIST_BASE	(0x18000000 + 0x1000)

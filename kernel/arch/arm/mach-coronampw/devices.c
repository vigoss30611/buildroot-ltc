/***************************************************
** arch/arm/mach-coronampw/devices.c
**
...
static struct imapx_adc_platform_data  imapx_adc_pdata = {
	.chan_bitmap = 0xE00,
};
...
#ifdef CONFIG_CORONAMPW_FPGA_PLATFORM
...
#ifdef CONFIG_CORONAMPW_LCD_SPI_ILI8961
...
#ifdef CONFIG_CORONAMPW_LCD_SPI_OTA5182A
...
#if defined(CONFIG_CORONAMPW_LCD_SPI_ILI8961)
	spi_register_board_info(spi_lcd_info, ARRAY_SIZE(spi_lcd_info));
#endif

#if defined(CONFIG_CORONAMPW_LCD_SPI_OTA5182A)

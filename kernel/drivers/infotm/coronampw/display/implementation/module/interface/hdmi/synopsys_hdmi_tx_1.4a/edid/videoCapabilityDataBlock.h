...
typedef struct
{
	int mQuantizationRangeSelectableRGB;

	int mQuantizationRangeSelectableYCC;
...
/**
 * @return TRUE if Quantization Range for RGB is Selectable
 */
int videoCapabilityDataBlock_GetQuantizationRangeSelectableRGB(videoCapabilityDataBlock_t * vcdb);

/**
 * @return TRUE if Quantization Range for YCC is Selectable
 */

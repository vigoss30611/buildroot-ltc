/*
 * register_coronampw.h - coronampw display register defination
 *
...
/*Note: In CORONAMPW platform, IDS0 REG BASE is 0x22300000 and the IDS1 is no exist */

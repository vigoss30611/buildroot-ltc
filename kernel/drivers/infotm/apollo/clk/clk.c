...
static struct bus_and_dev_clk_info dev_clk_info[] = {
	DEV_CLK_INFO(BUS1, 0, DPLL/*DPLL*/, 0, 63/*6*//*3*/, ENABLE),
	/* default bus3 setting by shaft */
	DEV_CLK_INFO(BUS3, 0, EPLL, 0, 1, DISABLE),
	/* bus4 bus5 do not use in imapx9*/
    //fengwu 20150513 change EPLL to DPLL. 596M->1536M. 
	//DEV_CLK_INFO(BUS4, 0, EPLL, 0, 4, ENABLE),
	DEV_CLK_INFO(BUS4, 0, DPLL, 0, 6, DISABLE),
	DEV_CLK_INFO(BUS6, 0, DEFAULT_SRC/*EPLL*/, 0, 8/*3*/, ENABLE), // changed by linyun.xiong @2015-11-14 for slove audio unstable issue
        DEV_CLK_INFO(IDS1_EITF_CLK_SRC, 0, EPLL, 0, 7/*7*/, DISABLE),
	DEV_CLK_INFO(IDS1_OSD_CLK_SRC, 0, EPLL, 0, 3, DISABLE),
	...
	DEV_CLK_INFO(SD0_CLK_SRC, 0, DPLL, 0, 31, DISABLE),
#else	
	DEV_CLK_INFO(SD0_CLK_SRC, 0, EPLL, 0, 14, DISABLE),
#endif	
	DEV_CLK_INFO(HDMI_CLK_SRC, 1, DPLL, 4, 3, ENABLE),
	...
	DEV_CLK_INFO(CLKOUT0_CLK_SRC, 0, /*DPLL*/DPLL, 0, 63, /*ENABLE*/DISABLE),
	...
	DEV_CLK_INFO(VDEC264_CLK_SRC, 0, DPLL, 0, 0, DISABLE),
	DEV_CLK_INFO(VENC264_CLK_SRC, 0, DPLL, 0, 0, DISABLE),
	DEV_CLK_INFO(VDEC265_CLK_SRC, 0, DPLL, 0, 0, DISABLE),
	DEV_CLK_INFO(VENC265_CLK_SRC, 0, DPLL, 0, 0, DISABLE),
};
...
static struct imapx_clk_init dev_clk[] = {
	...
	CLK_INIT("clk-out0", "imap-clk0", "imap-clk0", CLKOUT0_CLK_SRC),
	CLK_INIT("camo", "imap-camo", "imap-camo", CAMO_CLK_SRC),
	CLK_INIT("ddr-phy", "imap-ddr-phy", "imap-ddr-phy", DDRPHY_CLK_SRC),
	CLK_INIT("crypto", "imap-crypto", "imap-crypto", CRYPTO_CLK_SRC),
	...
	CLK_INIT("vdec264", "imap-vdec264", "imap-vdec264", VDEC264_CLK_SRC),
	CLK_INIT("venc264", "imap-venc264", "imap-venc264", VENC264_CLK_SRC),
	CLK_INIT("vdec265", "imap-vdec265", "imap-vdec265", VDEC265_CLK_SRC),
	CLK_INIT("venc265", "imap-venc265", "imap-venc265", VENC265_CLK_SRC),
};
...
static struct imapx_clk_init bus_clk[] = {
	...
	CLK_INIT("ids1", "imap-ids.1", "imap-ids1", BUS3),
	CLK_INIT("hdmi-tx", "imap-hdmi-tx", "imap-hdmi-tx", BUS3),
	CLK_INIT("crypto-dma", "imap-crypto-dma", "imap-crypto", BUS3),
	CLK_INIT("fodet", "imap-fodet", "imap-fodet", BUS3),
	CLK_INIT("ispost", "imap-ispost", "imap-ispost", BUS3),
	CLK_INIT("vdec264-ctrl", "imap-vdec264-ctrl", "imap-vdec264-ctrl", BUS4),
	CLK_INIT("venc264-ctrl", "imap-venc264-ctrl", "imap-venc264-ctrl", BUS4),
	CLK_INIT("vdec265-ctrl", "imap-vdec265-ctrl", "imap-vdec265-ctrl", BUS4),
	CLK_INIT("venc265-ctrl", "imap-venc265-ctrl", "imap-venc265-ctrl", BUS4),

...
if [ ""$1 = "STA" ]; then
    ...
    ##insmod /ko/esp8089.ko "firmware_path=$AP_PATH/firmware/fw_bcm43438a0.bin nvram_path=$AP_PATH/firmware/nvram_ap6212.txt iface_name=wlan0"
    insmod /mnt1/ko/esp8089.ko 
    sleep 3
...
if [ ""$1 = "AP" ]; then        
	...
	busybox ifconfig wlan0 down
        rmmod esp8089
        insmod /mnt1/ko/esp8089.ko 
####"firmware_path=$AP_PATH/firmware/fw_bcm43438a0_apsta.bin nvram_path=$AP_PATH/firmware/nvram_ap6212.txt iface_name=wlan0"
        sleep 3
        echo 1 > /sys/class/rfkill/rfkill1/state
        cd $AP_PATH

...
#    define PDEBUG(fmt, args...) printk( KERN_INFO "vench2:%3d ->" fmt,__LINE__,  ## args)
#  else
...
#endif
#define PMSG(fmt, args...) printk( KERN_INFO "vench2:%3d ->" fmt,__LINE__,  ## args)
#define PERROR(fmt, args...) printk( KERN_INFO "vench2 error:%3d ->" fmt,__LINE__,  ## args)

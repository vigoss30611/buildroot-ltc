...
#else
static inline int i80_wait_idle(void) { return 0; }
static inline void i80_wait_frame_end(void) {}
static inline void i80_lcdc_enable(int en) {}
static inline void i80_enable(int flags) {}
static inline void i80_set_clock_cycle(struct i80_cycles *cycle) {}
static inline void i80_set_int_mask(enum I80_INT_TYPE type) {}
static inline void i80_set_main_lcd(enum MAIN_LCD type) {}
static inline void i80_set_date_structure(struct i80_data *data) {}
static inline void i80_set_autocmd(struct i80_autocmd *cmd) {}
static inline void i80_set_cmd(struct i80_cmd *cmd)  {}
static inline void i80_mannual_write_once(int data) {}
static inline int i80_mannual_read_once(void) { return 0; }
static inline void i80_mannual_ctrl(enum SIGNAL_CTRL ctrl, int value) {}
static inline void i80_mannual_init(void) {}
static inline void i80_mannual_deinit(void) {}
static inline void i80_trigger_normal_cmd(int flags) {}
static inline void i80_clear_cmd_list(void) {}
static inline void i80_default_cfg(int format) {}
#endif

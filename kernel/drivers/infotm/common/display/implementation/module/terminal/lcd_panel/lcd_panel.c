...
static int dss_init_module(int idsx)
{
	...
	/* Config lcd pads */
//	if(imapx_pad_init((idsx ? "rgb1" : "rgb0")) == -1 ){
...
//		imapx_pad_set_mode(1, 1, lcd_gpio.back_light_gpio);
//		imapx_pad_set_outdat(!lcd_gpio.back_light_polarity, 1, lcd_gpio.back_light_gpio);
//		imapx_pad_set_dir(0, 1, lcd_gpio.back_light_gpio);
		if(item_exist("config.uboot.logo")){
			unsigned char str[ITEM_MAX_LEN] = {0};
			item_string(str,"config.uboot.logo",0);
			if(strncmp(str,"0",1) == 0 )
...
//		imapx_pad_set_mode(1, 1, lcd_gpio.master_gpio);		/* Function: GPIO */
//		imapx_pad_set_outdat(!lcd_gpio.master_polarity, 1, lcd_gpio.master_gpio);	/* Inactive */
//		imapx_pad_set_dir(0, 1, lcd_gpio.master_gpio);		/* Direction: Output */
		if ( 0 == ubootLogoState || init != 0)
...
//		imapx_pad_set_mode(1, 1, lcd_gpio.dvdd_gpio);
//		imapx_pad_set_dir(0, 1, lcd_gpio.dvdd_gpio);
//		imapx_pad_set_outdat(!lcd_gpio.dvdd_polarity, 1, lcd_gpio.dvdd_gpio);
...
//		imapx_pad_set_mode(1, 1, lcd_gpio.avdd_gpio);
//		imapx_pad_set_dir(0, 1, lcd_gpio.avdd_gpio);
//		imapx_pad_set_outdat(!lcd_gpio.avdd_polarity, 1, lcd_gpio.avdd_gpio);
...
//		imapx_pad_set_mode(1, 1, lcd_gpio.vgh_gpio);
//		imapx_pad_set_dir(0, 1, lcd_gpio.vgh_gpio);
//		imapx_pad_set_outdat(!lcd_gpio.vgh_polarity, 1, lcd_gpio.vgh_gpio);
...
//		imapx_pad_set_mode(1, 1, lcd_gpio.vgl_gpio);
//		imapx_pad_set_dir(0, 1, lcd_gpio.vgl_gpio);
//		imapx_pad_set_outdat(!lcd_gpio.vgl_polarity, 1, lcd_gpio.vgl_gpio);

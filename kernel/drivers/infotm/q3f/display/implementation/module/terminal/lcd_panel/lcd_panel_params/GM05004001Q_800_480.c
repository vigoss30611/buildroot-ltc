...
static struct lcd_power_sequence pwr_seq[] = {
	{LCDPWR_MASTER_EN, 1},		 // LCD_BEN, evb_vb(GPIO121), controls main power of LCD.
//	{LCDPWR_DVDD_EN, 30},
//	{LCDPWR_AVDD_EN, 20},
//	{LCDPWR_OUTPUT_EN, 1},		// 10 VSD, 317ms
//	{LCDPWR_BACKLIGHT_EN, 250},
	{LCDPWR_BACKLIGHT_EN, 30},	// LCD_BL_EN, evb_vb(GPIO64), controls LED+ and LED- power of LCD
};

struct lcd_panel_param panel_GM05004001Q_800_480 = {

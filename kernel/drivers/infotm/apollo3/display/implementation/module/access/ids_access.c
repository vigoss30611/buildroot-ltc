...
static char * ids_parent = IMAP_IDS0_PARENT_CLK;
static char * ids_clk[] = {IMAP_IDS_0_CLK, IMAP_IDS0_OSD_CLK, IMAP_IDS0_EITF_CLK};
...
int ids_access_Initialize(int idsx, struct resource *res)
{
	...
	dss_trace("%s base addr : 0x%x\n", __func__, (u32)base_addr);
...
int  ids_get_base_addr(int idsx)
{
	return (u32)base_addr;
}

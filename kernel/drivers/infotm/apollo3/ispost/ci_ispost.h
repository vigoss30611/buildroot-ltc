#ifndef __CI_ISPOST_APOLLO3_H__
#define __CI_ISPOST_APOLLO3_H__
...
typedef enum _GRID_SIZE {
	...
	GRID_SIZE_32_32,
#if 0
	GRID_SIZE_64_64,        // Not for Q3 and APOLLO3 use.
...
typedef struct _OV_INFO_APOLLO3 {
...
} OV_INFO_APOLLO3, *POV_INFO_APOLLO3;

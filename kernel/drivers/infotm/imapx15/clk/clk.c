...
static struct bus_and_dev_clk_info dev_clk_info[] = {
	...
	DEV_CLK_INFO(BUS3, 0, EPLL, 0, 0, ENABLE),
	...
	DEV_CLK_INFO(BUS7, 0, DPLL, 0, 5, ENABLE),
	...
	DEV_CLK_INFO(NFECC_CLK_SRC, 0, EPLL, 0, 2, ENABLE),
	...
	DEV_CLK_INFO(DMIC_CLK_SRC, 0, DPLL, 0, 9, ENABLE),
};
...
static struct imapx_clk_init dev_clk[] = {
	...
	CLK_INIT("dmic", "imap-dmic", "imap-dmic", DMIC_CLK_SRC),
};

static struct imapx_clk_init bus_clk[] = {
	CLK_INIT("ids0", "imap-ids.0", "imap-ids0", BUS1),
	CLK_INIT("ids1", "imap-ids.1", "imap-ids1", BUS2),
	CLK_INIT("gps", "imap-gps", NULL, BUS2),
	CLK_INIT("crypto-dma", "imap-crypto-dma", "imap-crypto", BUS2),
	CLK_INIT("gpu", "imap-gpu", "imap-gpu", BUS3),
	CLK_INIT("vdec", "imap-vdec", "imap-vdec", BUS4),
	CLK_INIT("venc", "imap-venc264", "imap-venc264", BUS4),
	CLK_INIT("isp", "imap-isp", "imap-isp", BUS5),
	CLK_INIT("mipi-csi", "imap-mipi-csi", "imap-mipi-csi", BUS5),
	CLK_INIT("tsif", "imap-tsif", "imap-tsif", BUS5),
	...
	CLK_INIT("camif", "imap-camif", "imap-camif", BUS5),
	CLK_INIT("sata", "imap-sata", "imap-sata", BUS7),
...
static struct imapx_clk_init apb_clk[] = {
	...
	CLK_APB_INIT("dma", "dma-pl330", "dma-pl330"),
	...
	CLK_APB_INIT("simc0", "imap-simc.0", "imap-simc"),
	CLK_APB_INIT("simc1", "imap-simc.1", "imap-simc"),
	CLK_APB_INIT("keyboard", "imap-keybd", NULL),

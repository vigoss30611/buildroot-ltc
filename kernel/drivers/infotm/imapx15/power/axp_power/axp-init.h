...
#if defined (CONFIG_KP_AXP20)
	uint8_t ocv_cap[31];
	if(item_exist("power.curve.ocv")) {
		ocv_cap[0]  = item_integer("power.curve.ocv", 0);
		ocv_cap[1]  = 0xC1;
		ocv_cap[2]  = item_integer("power.curve.ocv", 1);
		ocv_cap[3]  = 0xC2;
		ocv_cap[4]  = item_integer("power.curve.ocv", 2);
		ocv_cap[5]  = 0xC3;
		ocv_cap[6]  = item_integer("power.curve.ocv", 3);
		ocv_cap[7]  = 0xC4;
		ocv_cap[8]  = item_integer("power.curve.ocv", 4);
		ocv_cap[9]  = 0xC5;
		ocv_cap[10] = item_integer("power.curve.ocv", 5);
		ocv_cap[11] = 0xC6;
		ocv_cap[12] = item_integer("power.curve.ocv", 6);
		ocv_cap[13] = 0xC7;
		ocv_cap[14] = item_integer("power.curve.ocv", 7);
		ocv_cap[15] = 0xC8;
		ocv_cap[16] = item_integer("power.curve.ocv", 8);
		ocv_cap[17] = 0xC9;
		ocv_cap[18] = item_integer("power.curve.ocv", 9);
		ocv_cap[19] = 0xCA;
		ocv_cap[20] = item_integer("power.curve.ocv", 10);
		ocv_cap[21] = 0xCB;
		ocv_cap[22] = item_integer("power.curve.ocv", 11);
		ocv_cap[23] = 0xCC;
		ocv_cap[24] = item_integer("power.curve.ocv", 12);
		ocv_cap[25] = 0xCD;
		ocv_cap[26] = item_integer("power.curve.ocv", 13);
		ocv_cap[27] = 0xCE;
		ocv_cap[28] = item_integer("power.curve.ocv", 14);
		ocv_cap[29] = 0xCF;
		ocv_cap[30] = item_integer("power.curve.ocv", 15);
	}else {
		ocv_cap[0]  = OCVREG0;
		ocv_cap[1]  = 0xC1;
		ocv_cap[2]  = OCVREG1;

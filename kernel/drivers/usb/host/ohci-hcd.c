...
#if defined(CONFIG_ARCH_IMAPX910) || defined(CONFIG_ARCH_IMAPX15) || defined(CONFIG_ARCH_APOLLO) || defined(CONFIG_ARCH_Q3F) ||defined(CONFIG_ARCH_APOLLO3) || defined(CONFIG_ARCH_CORONAMPW)
#include "ohci-imapx9.c"
#define PLATFORM_DRIVER		ohci_imapx9_driver
#endif

...
extern void otg_monitor_set_enumerated(void);
...
int usb_string_ids_tab(struct usb_composite_dev *cdev, struct usb_string *str)
{
	...
	for (; str->s; ++str) {
		/* BUGFIX: it is root cause that enum count is not more then 125 */

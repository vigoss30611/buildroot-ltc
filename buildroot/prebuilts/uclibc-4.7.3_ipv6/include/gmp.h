...
#define __GMP_CC "/nfs/dev/buildroot-2014.02/output/host/usr/bin/ccache /usr/bin/gcc -std=gnu99"
#define __GMP_CFLAGS "-O2 -I/nfs/dev/buildroot-2014.02/output/host/usr/include"

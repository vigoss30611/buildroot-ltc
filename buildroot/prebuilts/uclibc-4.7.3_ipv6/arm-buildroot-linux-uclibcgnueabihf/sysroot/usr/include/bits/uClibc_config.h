...
#define __KERNEL_HEADERS__ "/nfs/dev/buildroot-2014.02/output/host/usr/arm-buildroot-linux-uclibcgnueabihf/sysroot/usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/nfs/dev/buildroot-2014.02/output/host/usr/bin/arm-buildroot-linux-uclibcgnueabihf-"

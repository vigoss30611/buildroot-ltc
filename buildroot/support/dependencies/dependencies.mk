...
$(shell buildroot/support/dependencies/check-host-$(1).sh $(2))
endef
-include $(sort $(wildcard buildroot/support/dependencies/check-host-*.mk))
...
core-dependencies:
	@HOSTCC="$(firstword $(HOSTCC))" MAKE="$(MAKE)" \
		...
		$(TOPDIR)/buildroot/support/dependencies/dependencies.sh

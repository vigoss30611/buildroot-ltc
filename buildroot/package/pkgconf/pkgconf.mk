...
define HOST_PKGCONF_INSTALL_WRAPPER
	$(INSTALL) -m 0755 -D buildroot/package/pkgconf/pkg-config.in \
		$(HOST_DIR)/usr/bin/pkg-config
	$(SED) 's,@PKG_CONFIG_LIBDIR@,$(STAGING_DIR)/usr/lib/pkgconfig:$(STAGING_DIR)/usr/share/pkgconfig:$(STAGING_DIR)/usr/local/lib/pkgconfig,' \

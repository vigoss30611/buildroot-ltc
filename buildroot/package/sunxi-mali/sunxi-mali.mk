...
define SUNXI_MALI_INSTALL_STAGING_CMDS
	...
	$(INSTALL) -D -m 0644 buildroot/package/sunxi-mali/egl.pc \
		$(STAGING_DIR)/usr/lib/pkgconfig/egl.pc
	$(INSTALL) -D -m 0644 buildroot/package/sunxi-mali/glesv2.pc \
...
define SUNXI_MALI_INSTALL_INIT_SYSV
	$(INSTALL) -D -m 0755 buildroot/package/sunxi-mali/S80mali \

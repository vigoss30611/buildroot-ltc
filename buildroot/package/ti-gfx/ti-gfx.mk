...
define TI_GFX_INSTALL_STAGING_CMDS
	...
	$(INSTALL) -D -m 0644 buildroot/package/ti-gfx/egl.pc \
		$(STAGING_DIR)/usr/lib/pkgconfig/egl.pc
	$(INSTALL) -D -m 0644 buildroot/package/ti-gfx/glesv2.pc \
...
define TI_GFX_INSTALL_BINS_CMDS
	...
	$(if $(BR2_PACKAGE_TI_GFX_DEBUG),
		$(INSTALL) -D -m 0755 buildroot/package/ti-gfx/esrev.sh \
...
define TI_GFX_INSTALL_CONF_CMDS
	...
	$(INSTALL) -D -m 0644 buildroot/package/ti-gfx/powervr.ini \
...
define TI_GFX_INSTALL_INIT_SYSV
	$(INSTALL) -D -m 0755 buildroot/package/ti-gfx/S80ti-gfx \

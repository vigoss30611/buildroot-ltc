...
define DOSFSTOOLS_INSTALL_INITRD
	$(TARGET_STRIP) -s $(@D)/mkfs.fat
	mkdir -p $(TARGET_INITRD_DIR)/sbin/
	$(INSTALL) -m 0755 $(@D)/mkfs.fat  $(TARGET_INITRD_DIR)/sbin/
endef

DOSFSTOOLS_POST_INSTALL_TARGET_HOOKS += DOSFSTOOLS_INSTALL_INITRD

...
define HOST_GCC_APPLY_POWERPC_PATCH
	buildroot/support/scripts/apply-patches.sh $(@D) buildroot/package/gcc/$(GCC_VERSION) powerpc-link-with-math-lib.patch.conditional
endef
endif
endif

define HOST_GCC_APPLY_PATCHES
	if test -d buildroot/package/gcc/$(GCC_VERSION); then \
	  buildroot/support/scripts/apply-patches.sh $(@D) buildroot/package/gcc/$(GCC_VERSION) \*.patch ; \
	fi;
...
include $(sort $(wildcard buildroot/package/gcc/*/*.mk))

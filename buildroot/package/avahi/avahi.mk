...
define AVAHI_INSTALL_AUTOIPD
	$(INSTALL) -m 0755 buildroot/package/avahi/S05avahi-setup.sh $(TARGET_DIR)/etc/init.d/
...
define AVAHI_INSTALL_DAEMON_INITSCRIPT
	$(INSTALL) -m 0755 buildroot/package/avahi/S50avahi-daemon $(TARGET_DIR)/etc/init.d/
endef

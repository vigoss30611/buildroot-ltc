...
define E2FSPROGS_BUILD_SMKE2FS
	$(TARGET_MAKE_ENV) $(MAKE) -C $(@D)/misc mke2fs.static
endef

ifeq ($(BR2_PACKAGE_E2FSPROGS_MKE2FS),y)
E2FSPROGS_POST_BUILD_HOOKS = E2FSPROGS_BUILD_SMKE2FS
endif
...
define E2FSPROGS_TARGET_SMKE2FS
	mkdir -p $(TARGET_INITRD_DIR)/sbin
	$(TARGET_STRIP) -s $(@D)/misc/mke2fs.static
	$(INSTALL) -m 0755 $(@D)/misc/mke2fs.static $(TARGET_INITRD_DIR)/sbin/mke2fs
	ln -sf mke2fs $(TARGET_INITRD_DIR)/sbin/mkfs.ext2
	ln -sf mke2fs $(TARGET_INITRD_DIR)/sbin/mkfs.ext3
	ln -sf mke2fs $(TARGET_INITRD_DIR)/sbin/mkfs.ext4
	ln -sf mke2fs $(TARGET_INITRD_DIR)/sbin/mkfs.ext4dev
endef
...
ifeq ($(BR2_PACKAGE_E2FSPROGS_MKE2FS),y)
E2FSPROGS_POST_INSTALL_TARGET_HOOKS += E2FSPROGS_TARGET_SMKE2FS

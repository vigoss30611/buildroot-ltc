...
LINUX_FUSION_MAKE_OPTS += KERNEL_BUILD=$(LINUX_BUILDDIR)
LINUX_FUSION_MAKE_OPTS += KERNEL_SOURCE=$(LINUX_SRCDIR)
...
define LINUX_FUSION_INSTALL_TARGET_CMDS
	...
	cp -dpf buildroot/package/linux-fusion/40-fusion.rules $(LINUX_FUSION_ETC_DIR)
endef

...
define DHCP_INSTALL_SERVER
	...
	$(INSTALL) -m 0755 -D buildroot/package/dhcp/S80dhcp-server \
		$(TARGET_DIR)/etc/init.d/S80dhcp-server
	$(INSTALL) -m 0644 -D buildroot/package/dhcp/dhcpd.conf \
...
define DHCP_INSTALL_RELAY
	...
	$(INSTALL) -m 0755 -D buildroot/package/dhcp/S80dhcp-relay \
...
define DHCP_INSTALL_CLIENT
	...
	$(INSTALL) -m 0644 -D buildroot/package/dhcp/dhclient.conf \
		$(TARGET_DIR)/etc/dhcp/dhclient.conf
	$(INSTALL) -m 0755 -D buildroot/package/dhcp/dhclient-script \

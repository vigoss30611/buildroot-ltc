################################################################################
#
# Build the iso96600 target filesystem image
#
...
$(BINARIES_DIR)/rootfs.iso9660: host-cdrkit host-fakeroot linux rootfs-cpio grub
	@$(call MESSAGE,"Generating target filesystem image rootfs.iso9660")
	...
	echo "$(HOST_DIR)/usr/bin/genisoimage -R -b buildroot/boot/grub/stage2_eltorito -no-emul-boot " \

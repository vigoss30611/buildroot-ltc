...
#ifndef _PCM_LIVE_AUDIO_SERVER_MEDIA_SUBSESSION_HH
#define _PCM_LIVE_AUDIO_SERVER_MEDIA_SUBSESSION_HH

#ifndef _ON_DEMAND_SERVER_MEDIA_SUBSESSION_HH
#include "OnDemandServerMediaSubsession.hh"
#endif

class PCMLiveAudioServerMediaSubsession: public OnDemandServerMediaSubsession{
public:
  static PCMLiveAudioServerMediaSubsession*
...
protected:
  PCMLiveAudioServerMediaSubsession(UsageEnvironment& env, char const* fileName,
				    Boolean reuseFirstSource, Boolean convertToULaw);
      // called only by createNew();
  virtual ~PCMLiveAudioServerMediaSubsession();

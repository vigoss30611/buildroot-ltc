...
class H264or5LiveVideoServerMediaSubsession: public OnDemandServerMediaSubsession {
public:
  static H264or5LiveVideoServerMediaSubsession*
...
protected:
  H264or5LiveVideoServerMediaSubsession(UsageEnvironment& env,
				      char const* chanID, Boolean reuseFirstSource);
      // called only by createNew();
  virtual ~H264or5LiveVideoServerMediaSubsession();
...
private:
  char const * fChanID;
  enum v_media_type   fEncoderType ;
  char* fAuxSDPLine;

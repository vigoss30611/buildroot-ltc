...
#define SV_LEFTMARGIN           0
#define SV_TOPMARGIN            0
#define SV_RIGHTMARGIN          0
#define SV_BOTTOMMARGIN         0

#define SV_DEF_ITEMHEIGHT       0

#define SPV_CTRL_SCROLLVIEW     "spv_scrollview"

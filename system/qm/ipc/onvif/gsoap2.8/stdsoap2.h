...
#define SOAP_BUFLEN (16 * 1024)
#define SOAP_IDHASH (199)
#define SOAP_PTRHASH (256)
...
{ short state;			/* 0 = uninitialized, 1 = initialized, 2 = copy of another soap struct */
  ...
  char msgbuf[10024];	/* in/out buffer for HTTP/MIME headers >=1024 bytes */
...
# endif
  ...
  virtual ~soap();
#else
 int (*fxmloutput)(struct soap*, char*, size_t,void *cgihc);
  void *cgihc;
#endif
  struct onvif_config *pConfig;
};
...
#define soap_malloc(soap, size) soap_trace_malloc(soap, size, __FILE__, __LINE__)

#else
SOAP_FMAC1 void* SOAP_FMAC2 soap_malloc(struct soap*, size_t);
SOAP_FMAC1 void* SOAP_FMAC2 soap_malloc_v2(struct soap*, size_t);
#endif

SOAP_FMAC1 void* SOAP_FMAC2 soap_trace_malloc(struct soap*, size_t, const char* file, int line);

...
#ifndef WITH_IPV6	/* stdsoap2.h declaration macro */
# define WITH_IPV6
#endif
...
{ short state;			/* 0 = uninitialized, 1 = initialized, 2 = copy of another soap struct */
  ...
  char msgbuf[10240];	/* in/out buffer for HTTP/MIME headers >=1024 bytes */

...
public:  // parameters
...
#ifdef INFOTM_AWB_PATCH
	const static ParamDef<float> PID_MARGIN;
	const static ParamDef<float> PID_KP;
	const static ParamDef<float> PID_KD;
	const static ParamDef<float> PID_KI;
#endif
#ifdef INFOTM_ISP
	...
	const static ParamDef<float> SW_AWB_USE_ORI_CCM_NRML_GAIN_LMT;
	const static ParamDef<float> SW_AWB_USE_ORI_CCM_NRML_BRIGHTNESS_LMT;
	const static ParamDef<float> SW_AWB_USE_ORI_CCM_NRML_UNDER_EXPOSE_LMT;
	const static ParamDef<float> SW_AWB_USE_STD_CCM_LOW_LUX_GAIN_LMT;
	const static ParamDef<float> SW_AWB_USE_STD_CCM_DARK_GAIN_LMT;
	const static ParamDef<float> SW_AWB_USE_STD_CCM_LOW_LUX_BRIGHTNESS_LMT;
	const static ParamDef<float> SW_AWB_USE_STD_CCM_LOW_LUX_UNDER_EXPOSE_LMT;
	const static ParamDef<float> SW_AWB_USE_STD_CCM_DARK_BRIGHTNESS_LMT;
	const static ParamDef<float> SW_AWB_USE_STD_CCM_DARK_UNDER_EXPOSE_LMT;
#endif //#if defined(INFOTM_SW_AWB_METHOD)
#if defined(INFOTM_SW_AWB_METHOD) || defined(INFOTM_SW_AWB_METHOD)
	const static ParamDef<float> HW_SW_AWB_UPDATE_SPEED;
	const static ParamDef<float> HW_SW_AWB_DROP_RATIO;

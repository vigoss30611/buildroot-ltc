...
public:
	LiveFeedView(QGraphicsView *parent = 0); // Class constructor
...
public slots:
	void imageReceived(QImage *pImage, int type, int format, int mosaic, int width, int height); // Called when ImageHandler finished receiving new frame

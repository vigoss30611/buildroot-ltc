...
VisionLive::MIEWidget::MIEWidget(QWidget *parent): QWidget(parent)
{
	...
	QObject::connect(MIEWidget_lumaMin_sb, SIGNAL(valueChanged(double)), this, SLOT(updateSlices(double)));
    QObject::connect(MIEWidget_lumaMax_sb, SIGNAL(valueChanged(double)), this, SLOT(updateSlices(double)));

	QObject::connect(MIEWidget_cbCenter_sl, SIGNAL(valueChanged(double)), MIEWidget_cbCenter_sb, SLOT(setValue(double)));
    QObject::connect(MIEWidget_crCenter_sl, SIGNAL(valueChanged(double)), MIEWidget_crCenter_sb, SLOT(setValue(double)));
    QObject::connect(MIEWidget_aspect_sl, SIGNAL(valueChanged(double)), MIEWidget_aspect_sb, SLOT(setValue(double)));
	QObject::connect(MIEWidget_rotation_sl, SIGNAL(valueChanged(double)), MIEWidget_rotation_sb, SLOT(setValue(double)));

	QObject::connect(MIEWidget_cbCenter_sb, SIGNAL(valueChanged(double)), MIEWidget_cbCenter_sl, SLOT(setValueD(double)));
    QObject::connect(MIEWidget_crCenter_sb, SIGNAL(valueChanged(double)), MIEWidget_crCenter_sl, SLOT(setValueD(double)));
    QObject::connect(MIEWidget_aspect_sb, SIGNAL(valueChanged(double)), MIEWidget_aspect_sl, SLOT(setValueD(double)));
	QObject::connect(MIEWidget_rotation_sb, SIGNAL(valueChanged(double)), MIEWidget_rotation_sl, SLOT(setValueD(double)));

    QObject::connect(MIEWidget_cbCenter_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
    QObject::connect(MIEWidget_crCenter_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
    QObject::connect(MIEWidget_aspect_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
	QObject::connect(MIEWidget_rotation_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));

	QObject::connect(MIEWidget_gain0_sl, SIGNAL(valueChanged(double)), MIEWidget_gain0_sb, SLOT(setValue(double)));
	QObject::connect(MIEWidget_gain1_sl, SIGNAL(valueChanged(double)), MIEWidget_gain1_sb, SLOT(setValue(double)));
	QObject::connect(MIEWidget_gain2_sl, SIGNAL(valueChanged(double)), MIEWidget_gain2_sb, SLOT(setValue(double)));
	QObject::connect(MIEWidget_gain3_sl, SIGNAL(valueChanged(double)), MIEWidget_gain3_sb, SLOT(setValue(double)));

	QObject::connect(MIEWidget_gain0_sb, SIGNAL(valueChanged(double)), MIEWidget_gain0_sl, SLOT(setValueD(double)));
	QObject::connect(MIEWidget_gain1_sb, SIGNAL(valueChanged(double)), MIEWidget_gain1_sl, SLOT(setValueD(double)));
	QObject::connect(MIEWidget_gain2_sb, SIGNAL(valueChanged(double)), MIEWidget_gain2_sl, SLOT(setValueD(double)));
	QObject::connect(MIEWidget_gain3_sb, SIGNAL(valueChanged(double)), MIEWidget_gain3_sl, SLOT(setValueD(double)));

	QObject::connect(MIEWidget_chromaExtent0_sl, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent0_sb, SLOT(setValue(double)));
	QObject::connect(MIEWidget_chromaExtent1_sl, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent1_sb, SLOT(setValue(double)));
	QObject::connect(MIEWidget_chromaExtent2_sl, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent2_sb, SLOT(setValue(double)));
	QObject::connect(MIEWidget_chromaExtent3_sl, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent3_sb, SLOT(setValue(double)));

	QObject::connect(MIEWidget_chromaExtent0_sb, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent0_sl, SLOT(setValueD(double)));
	QObject::connect(MIEWidget_chromaExtent1_sb, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent1_sl, SLOT(setValueD(double)));
	QObject::connect(MIEWidget_chromaExtent2_sb, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent2_sl, SLOT(setValueD(double)));
	QObject::connect(MIEWidget_chromaExtent3_sb, SIGNAL(valueChanged(double)), MIEWidget_chromaExtent3_sl, SLOT(setValueD(double)));

    QObject::connect(MIEWidget_chromaExtent0_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
	QObject::connect(MIEWidget_chromaExtent1_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
	QObject::connect(MIEWidget_chromaExtent2_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
	QObject::connect(MIEWidget_chromaExtent3_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));

	QObject::connect(MIEWidget_brightness_sl, SIGNAL(valueChanged(double)), MIEWidget_brightness_sb, SLOT(setValue(double)));
    QObject::connect(MIEWidget_contrast_sl, SIGNAL(valueChanged(double)), MIEWidget_contrast_sb, SLOT(setValue(double)));
    QObject::connect(MIEWidget_contrastCenter_sl, SIGNAL(valueChanged(double)), MIEWidget_contrastCenter_sb, SLOT(setValue(double)));
    QObject::connect(MIEWidget_saturation_sl, SIGNAL(valueChanged(double)), MIEWidget_saturation_sb, SLOT(setValue(double)));
    QObject::connect(MIEWidget_hue_sl, SIGNAL(valueChanged(double)), MIEWidget_hue_sb, SLOT(setValue(double)));

	QObject::connect(MIEWidget_brightness_sb, SIGNAL(valueChanged(double)), MIEWidget_brightness_sl, SLOT(setValueD(double)));
    QObject::connect(MIEWidget_contrast_sb, SIGNAL(valueChanged(double)), MIEWidget_contrast_sl, SLOT(setValueD(double)));
    QObject::connect(MIEWidget_contrastCenter_sb, SIGNAL(valueChanged(double)), MIEWidget_contrastCenter_sl, SLOT(setValueD(double)));
    QObject::connect(MIEWidget_saturation_sb, SIGNAL(valueChanged(double)), MIEWidget_saturation_sl, SLOT(setValueD(double)));
    QObject::connect(MIEWidget_hue_sb, SIGNAL(valueChanged(double)), MIEWidget_hue_sl, SLOT(setValueD(double)));

    QObject::connect(MIEWidget_brightness_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
    QObject::connect(MIEWidget_contrast_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
    QObject::connect(MIEWidget_contrastCenter_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
    QObject::connect(MIEWidget_saturation_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
    QObject::connect(MIEWidget_hue_sb, SIGNAL(valueChanged(double)), this, SLOT(updateCenter(double)));
...
{
	_sliceBtns.push_back(MIEWidget_slice0_rb);
	_sliceBtns.push_back(MIEWidget_slice1_rb);
	_sliceBtns.push_back(MIEWidget_slice2_rb);
	_sliceBtns.push_back(MIEWidget_slice3_rb);

	_chromaExtents.push_back(MIEWidget_chromaExtent0_sb);
	_chromaExtents.push_back(MIEWidget_chromaExtent1_sb);
	_chromaExtents.push_back(MIEWidget_chromaExtent2_sb);
	_chromaExtents.push_back(MIEWidget_chromaExtent3_sb);

	// Hide ContrastCenter parameter
	label_10->setVisible(false);
    MIEWidget_contrastCenter_sb->setVisible(false);
	MIEWidget_contrastCenter_sl->setVisible(false);

	QObject::connect(MIEWidget_import_btn, SIGNAL(clicked()), this, SLOT(importValues()));
}
...
void VisionLive::MIEWidget::initLumaView()
{
	...
	MIEWidget_lumaLayout->addWidget(_pMIEWidget_lumaView_gv, 0, 0);
...
void VisionLive::MIEWidget::initCenterInputColorView()
{
	for(int i = 0; i < MIE_NUM_SLICES; i++)
    {
        ...
        MIEWidget_centerInputColourLayout->addWidget(_centerInputColourView[i], i);
	}
}
...
void VisionLive::MIEWidget::initCenterOutputColorView()
{
	for(int i = 0; i < MIE_NUM_SLICES; i++)
    {
        ...
        MIEWidget_centerOutputColourLayout->addWidget(_centerOutputColourView[i], i);
	}
}
...
void VisionLive::MIEWidget::initChromaView()
{
	...
	MIEWidget_chromaViewLayout->addWidget(_pMIEWidget_chromaView_gv, 0, 0);
...
void VisionLive::MIEWidget::modifyYCbCr(unsigned char &y, unsigned char &cb, unsigned char &cr)
{
    ...
    iY = (int)floor(iY*MIEWidget_contrast_sb->value());
    iY += (int)floor(MIEWidget_brightness_sb->value()*128.0);
#ifdef USE_MATH_NEON
    iCb = (cb-128)*(double)cosf_neon((float)(MIEWidget_hue_sb->value()*M_PI))+(cr-128)*(double)sinf_neon((float)(MIEWidget_hue_sb->value()*M_PI));
    iCr = (cr-128)*(double)cosf_neon((float)(MIEWidget_hue_sb->value()*M_PI))-(cb-128)*(double)sinf_neon((float)(MIEWidget_hue_sb->value()*M_PI));
#else
    iCb = (cb-128)*cos(MIEWidget_hue_sb->value()*M_PI)+(cr-128)*sin(MIEWidget_hue_sb->value()*M_PI);
    iCr = (cr-128)*cos(MIEWidget_hue_sb->value()*M_PI)-(cb-128)*sin(MIEWidget_hue_sb->value()*M_PI);
#endif
    iCb = (int)floor(iCb*MIEWidget_saturation_sb->value());
    iCr = (int)floor(iCr*MIEWidget_saturation_sb->value());
...
{
    double Ymin = MIEWidget_lumaMin_sb->value(), Ymax = MIEWidget_lumaMax_sb->value();

    if( Ymax < Ymin)
    {
        Ymin = Ymax;
        Ymax = MIEWidget_lumaMin_sb->value();
    }
...
void VisionLive::MIEWidget::updateCenter(double unused)
{
    ...
    {
        double x = (MIEWidget_cbCenter_sb->value()*CHROMA_SCENE_COORD_MULT)*CHROMA_SCENE_W + (CHROMA_SCENE_W/2.0);
        double y = CHROMA_SCENE_H - ((MIEWidget_crCenter_sb->value()*CHROMA_SCENE_COORD_MULT)*CHROMA_SCENE_H + (CHROMA_SCENE_H/2.0));
        unsigned char iy = 0.5, cb = (MIEWidget_cbCenter_sb->value()+0.5)*256, cr = (MIEWidget_crCenter_sb->value()+0.5)*256;
    ...
    for(int s = 0; s < MIE_NUM_SLICES; s++)
    {
        ...
        double norm_angle = MIEWidget_rotation_sb->value();
        double cb0 = MIEWidget_cbCenter_sb->value(), cr0 = MIEWidget_crCenter_sb->value();
#ifdef USE_MATH_NEON
...
#ifdef USE_MATH_NEON
		sqrt_base = ((double)sqrtf_neon((float)powf_neon(2.0f, (float)MIEWidget_aspect_sb->value())));
#else
		sqrt_base = (sqrt(pow(2.0, MIEWidget_aspect_sb->value())));
#endif
...
void VisionLive::MIEWidget::updateCenterColour()
{
    ...
    {
        unsigned char y = clip(_lumaSlice[slice]*255.0), cb = clip((MIEWidget_cbCenter_sb->value()+0.5f)*255.0), cr = clip((MIEWidget_crCenter_sb->value()+0.5f)*255.0);

        unsigned char rgb[3] = {0.5, MIEWidget_cbCenter_sb->value(), MIEWidget_crCenter_sb->value()};
...
void VisionLive::MIEWidget::mousePressed(QPointF pos, Qt::MouseButton button)
{
    ...
    if(button == Qt::LeftButton)
    {
        ...
        if(x >= MIEWidget_cbCenter_sb->minimum() && x <= MIEWidget_cbCenter_sb->maximum() &&
           y >= MIEWidget_crCenter_sb->minimum() && y <= MIEWidget_crCenter_sb->maximum())
        {
            MIEWidget_cbCenter_sb->setValue(x);
            MIEWidget_crCenter_sb->setValue(y);
...
void VisionLive::MIEWidget::importValues()
{
	...
	{
		MIEWidget_lumaMin_sb->setValue((double)_pixelInfo[0]/255.0f - 0.15);
		MIEWidget_lumaMax_sb->setValue((double)_pixelInfo[0]/255.0f + 0.15);
		MIEWidget_cbCenter_sb->setValue((double)_pixelInfo[1]/255.0f - 0.5f);
		MIEWidget_crCenter_sb->setValue((double)_pixelInfo[2]/255.0f - 0.5f);
	}
}

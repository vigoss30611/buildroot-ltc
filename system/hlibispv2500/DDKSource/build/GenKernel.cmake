...
#
# e.g. of usage
#	set(KO_SOURCES ${CMAKE_CURRENT_SOURCE_DIR}/felix_kn.c)
...
#
#	GenKernel_Makefile(${FELIXLIB_NAME} "${KO_CFLAGS}" "${KO_SOURCES}" "${KO_INCLUDES}" ${KO_BINARY_DIR} ${KO_MODE})
#	GenKernel_addTarget(${FELIXLIB_NAME}_KO ${KO_BINARY_DIR})
...
function(GenKernel_addTarget KO_MODULE_NAME KO_OUTDIR)
  ...
  add_custom_target(${KO_MODULE_NAME} ALL 
      COMMAND MAKEFLAGS= ${CMAKE_MAKE_PROGRAM} -C ${LINUX_KERNEL_BUILD_DIR} CROSS_COMPILE=${CROSS_COMPILE} M=${KO_OUTDIR} modules

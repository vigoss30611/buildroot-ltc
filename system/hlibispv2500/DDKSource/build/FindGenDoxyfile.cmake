...
# DOXY_HTML_EXTRA_FILES - watch out for the list, must be space separated not semi colon like cmake (look what GenerateDoxygen does to DOXY_INCLUDE_FILES) 
# DOXY_IMAGE_PATH - protected path to images
...
# 
# Example of usage: 
#   set (DOC_GEN ${FELIXLIB_INCLUDE_DIRS} ${PUBLIC_HEADERS} ${HEADERS} ${SOURCES})
#   GenerateDoxyfile (	${DOXYGEN_TEMPLATE} "${CMAKE_CURRENT_BINARY_DIR}/Doxyfile.private"
#      "${FELIXLIB_NAME} Internal documentation"
#      "${FELIX_BINARY_DIR}/doc_private"
#      FALSE
#      "${DOC_GEN}"
#   )
#

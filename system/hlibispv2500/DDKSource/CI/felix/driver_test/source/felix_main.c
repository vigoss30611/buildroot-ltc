...
int main(int argc,char * argv[])
{
    ...
    iRet = DYNCMD_RegisterParameter("-encOutCtx", DYNCMDTYPE_UINT,
        "Which context to use for the Encoder pipeline statistics output "\
        "(see FELIX_CORE:ENC_OUT_CTRL:ENC_OUT_CTRL_SEL)",
        &(parameters.ui8EncOutSelect));
    if (RET_FOUND != iRet && !bPrintHelp)
    {
        if (RET_NOT_FOUND != iRet)
        {
            LOG_ERROR("-encOutCtx expects an int but none was found\n");
            return EXIT_FAILURE;
        }
    }
    ...
    {
        snprintf(param_name, PARAM_NAME_S, "-CT%d_useLSH", i);
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_fixLSH", i);
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_LSHTile", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_INT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_LSHCorners", i);
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_LSHGrads", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_FLOAT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_encoder", i);
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_rawYUV", i);
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_YUV422", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_YUV10b", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_YUVAlloc", i);
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_YUVStrides", i);
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_YUVOffsets", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_display", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_RGB24", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_RGB10", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_DispAlloc", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_DispStride", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_DispOffset", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_dataExtraction", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_DEBitDepth", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_rawDisp", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_raw2DExtraction", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_raw2DFormat", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_raw2DAlloc", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_raw2DStride", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_raw2DOffset", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_rawTiff", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_HDRExtraction", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_HDRExtAlloc", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_HDRExtStride", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_HDRExtOffset", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_rawHDR", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_HDRInsertion", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_HDRInsRescale", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_nBuffers", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_nEncTiled", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_nDispTiled", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_nHDRExtTiled", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_nFrames", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
            "Number of frames to run for",
            &(parameters.sCapture[i].ui32RunForFrames));
        if (RET_FOUND != iRet && !bPrintHelp)
        {
            if (RET_NOT_FOUND != iRet)
            {
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_imager", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
            "The imager to use",
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_stats", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_INT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_enableTS", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_allocateLate", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_ENSNLines", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_escPitch", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_FLOAT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_dscPitch", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_FLOAT,
            "Encoder scaler horizontal and vertical pitch (ratio "\
            "input/output) - second value is optional and horizontal pitch "\
            "is duplicated",
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_black", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_DPF", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_INT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_DPFReadMap", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_RLTMode", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_RLTSlopes", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_FLOAT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_RLTKnee", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_UINT,
...
#ifdef FELIX_FAKE
        snprintf(param_name, PARAM_NAME_S, "-CT%d_regOverride", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-CT%d_checkCRC", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_BOOL8,
    ...
    {
        snprintf(param_name, PARAM_NAME_S, "-DG%d_inputFLX", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-DG%d_inputFrames", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
            "Number of frames to use from the DG input file",
            &(parameters.sDataGen[i].ui32Frames));
        if (RET_FOUND != iRet && !bPrintHelp)
        {
            if ( iRet != RET_NOT_FOUND )
            {
        ...
        snprintf(param_name, PARAM_NAME_S, "-DG%d_blanking", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-DG%d_MIPI_LF", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_COMMAND,
            "Flag to indicate we should use MIPI Line Flags for the "\
            "data generator", NULL);
        if (RET_FOUND == iRet)
        {
            parameters.sDataGen[i].bMIPIUsesLineFlag = IMG_TRUE;
        }
    ...
    {
        snprintf(param_name, PARAM_NAME_S, "-IntDG%d_inputFLX", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_STRING,
        ...
        snprintf(param_name, PARAM_NAME_S, "-IntDG%d_inputFrames", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
            "Number of frames to use from the IntDG input file",
            &(parameters.sIIFDG[i].uiFrames));
        if (RET_FOUND != iRet)
        {
            if (RET_NOT_FOUND != iRet)
            {
        ...
        snprintf(param_name, PARAM_NAME_S, "-IntDG%d_gasket", i);
        iRet = DYNCMD_RegisterParameter(param_name, DYNCMDTYPE_UINT,
        ...
        snprintf(param_name, PARAM_NAME_S, "-IntDG%d_blanking", i);
        iRet = DYNCMD_RegisterArray(param_name, DYNCMDTYPE_UINT,
            "Horizontal and vertical blanking to use",
    ...
    */
    ...
    for ( i = 0 ; i < CI_N_CONTEXT && parameters.uiRegisterTest != 1 ; i++ )
    {
            ...
            parameters.sCapture[i].iDPFEnabled > 1 )
        {
                ...
                parameters.sDataGen[imager].pszInputFLX != NULL )
            {
                ...
                if ( parameters.sCapture[i].ui32RunForFrames == 0 )
                {
                    parameters.sCapture[i].ui32RunForFrames = 
                        parameters.sDataGen[imager].ui32Frames;
                }
                iRet++;
            }
            else
    ...
    for ( i = 0 ; i < CI_N_CONTEXT ; i++ )
    {
        if ( parameters.sCapture[i].pszEncoderOutput != NULL )
        {
            IMG_FREE(parameters.sCapture[i].pszEncoderOutput);
            parameters.sCapture[i].pszEncoderOutput = NULL;
        }
        if ( parameters.sCapture[i].pszDisplayOutput != NULL )
        {
            IMG_FREE(parameters.sCapture[i].pszDisplayOutput);
            parameters.sCapture[i].pszDisplayOutput = NULL;
        }
        if ( parameters.sCapture[i].pszDataExtOutput != NULL )
        {
            IMG_FREE(parameters.sCapture[i].pszDataExtOutput);
            parameters.sCapture[i].pszDataExtOutput = NULL;
        }
        if ( parameters.sCapture[i].pszHDRextOutput != NULL )
        {
            IMG_FREE(parameters.sCapture[i].pszHDRextOutput);
            parameters.sCapture[i].pszHDRextOutput = NULL;
        }
        if (parameters.sCapture[i].pszHDRInsInput != NULL)
        {
            IMG_FREE(parameters.sCapture[i].pszHDRInsInput);
            parameters.sCapture[i].pszHDRInsInput = NULL;
        }
    }
    for ( i = 0 ; i < CI_N_EXT_DATAGEN ; i++ )
    {
        if ( parameters.sDataGen[i].pszInputFLX != NULL )
        {
          IMG_FREE(parameters.sDataGen[i].pszInputFLX);
          parameters.sDataGen[i].pszInputFLX = NULL;
        }
    }
...
static void printDG_Param(const struct DG_PARAM *param, FILE *file)
{
    ...
    PRINT_ELEM(file, param, ui32Frames, "u");
    for ( i = 0 ; i < 2 ; i++ )
    {
        PRINT_ELEM(file, param, aBlanking[i], "u");
    }
    //PRINT_ELEM(file, param, bUsesMIPI, "d");
...
static void printIIFDG_Param(const struct IIFDG_PARAM *param, FILE *file)
{
    ...
    PRINT_ELEM(file, param, pszInputFLX, "s");
    PRINT_ELEM(file, param, uiFrames, "u");
    for ( i = 0 ; i < 2 ; i++ )
    {
        PRINT_ELEM(file, param, aBlanking[i], "u");
    }
...
static void printCapture_Param(const struct CAPTURE_PARAM *param, FILE *file)
{
    ...
    PRINT_ELEM(file, param, ui32RunForFrames, "u");
...
void init_Param(struct CMD_PARAM *param)
{
    ...
    param->ui8EncOutSelect = CI_N_CONTEXT;
    param->uiUseMMU = 2;

...
struct CI_ALLOC_PARAM {
    ...
    IMG_UINT32 fd;
    /**
     * @brief [in] type of buffer (CI_ALLOC_ENC or CI_ALLOC_DISP) 
     * @note not used when de-registering
     */
    int type;
    /**
...
struct CI_PIPE_PARAM {
    /**
     * @brief [in] User side Pipeline configuration
     */
    CI_PIPELINE sUserPipeline;
    /**
     * @brief [in] Pipeline's ID
     */
    int identifier;
...
#ifdef INFOTM_ISP
/**
 * @brief Information to get register value
 *
 * @see CI_IOCTL_REG_GET
 */
struct KRN_CI_REG_PARAM {
    /**
     * @brief [in] Register memory space
     */
	IMG_CHAR *pchRegSpaceName;
    /**
     * @brief [in] Register offset
     */
    IMG_UINT32 ui32RegOffset;
    /**
     * @brief [in, out] Register value
     */
...
#define CI_IOCTL_GMAL_SET _IOR(CI_MAGIC, CI_GMALUT_GET, CI_MODULE_GMA_LUT*)
...
#define CI_IOCTL_PIPE_REG _IOR(CI_MAGIC, CI_PIPELINE_REGISTER, CI_PIPELINE*)
...
#define CI_IOCTL_SET_YUV _IOR(CI_MAGIC, CI_YUV_SET, int)
...
#ifdef INFOTM_ISP
#define CI_IOCTL_REG_GET _IOR(CI_MAGIC, CI_REG_GET, \
    struct CI_REG_PARAM*)
#define CI_IOCTL_REG_SET _IOWR(CI_MAGIC, CI_REG_SET, \
    struct CI_REG_PARAM*)

...
typedef struct MC_LSH
{
    ...
    IMG_UINT16 aSkip[2];  // CFA
    IMG_UINT16 aOffset[2];  // CFA
...
{
    /** @brief A combinaison of @ref DPFEnable values, 0 being none */
...
typedef struct MC_PIPELINE
{
     ...
     *
     * @warning does not differenciate between YUV and YVU: HW configuration
     * is not alterated by MC to match UV/VU order 
     */
...
typedef struct MC_STATS_HIS
{
    ...
    /**
     * @brief Region HistogramsAn array of widthxheight histograms with
     * nbins each
     */
    IMG_UINT32
...
/** WB Average color stats as part of @ref MC_STATS_WBS */
...
/** WBS modoule output stats configured with @ref MC_WBS */
...
/** @brief FLD module output possibilites */

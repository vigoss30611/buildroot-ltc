...
function(AddDirsToModulePath)
	get_filename_component(TAL_DIR "${CMAKE_CURRENT_LIST_FILE}" PATH)

 # include devif find path, doesn't matter if we are not building this
include(${TAL_DIR}/device_interface/UsePackage.cmake)

include(${TAL_DIR}/libraries/devif/UsePackage.cmake)


#	message("CMAKE_MODULE_PATH inside: ${CMAKE_MODULE_PATH}")
	set(CMAKE_MODULE_PATH ${CMAKE_MODULE_PATH} ${TAL_DIR} PARENT_SCOPE)
endfunction()

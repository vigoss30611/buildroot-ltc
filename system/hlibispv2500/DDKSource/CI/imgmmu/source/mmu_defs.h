...
******************************************************************************
 ...
 @brief Internal MMU library header used to define MMU information at compilation time and have access to the error printing functions

 @note some constants are defined as static cosnt values to propagate signed operations
...
static const IMG_SIZE VIRT_PAGE_TBL_MASK = (((1<<IMGMMU_DIR_SHIFT)-1) & ~( ((1<<IMGMMU_PAGE_SHIFT)-1)) );

...
#define INFOTM_NEW_GAMMA_CURVE
#define INFOTM_SUPPORT_TNM_BIG_LUMA_AREA
#define AUTO_CHANGE_DNS_STRENGTH
#define AUTO_CHANGE_SHA_STRENGTH
#define AUTO_CHANGE_TNM_STRENGTH
#define INFOTM_SUPPORT_STATIC_TNM_CURVE
#define AWB_LIMIT_GAIN_PATCH
#define AUTO_CHANGE_HIS_REGION
#define AUTO_CHANGE_DPF_STRENGTH
#endif

//#define INFOTM_LANCHOU_PROJECT
...
#define INFOTM_DUAL_SENSOR
#ifdef INFOTM_DUAL_SENSOR
//	#define INFOTM_DUAL_SENSOR_MERGE_BUFFER

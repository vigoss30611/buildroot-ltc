...
class IPU_ISP: public IPU {

public:
    std::list<IMG_UINT32> BuffersIDs[MAX_CAM_NB];
...
private:
    ...
    int CheckOutRes(IMG_UINT32 Idx, std::string name, int imgW, int imgH);
...
#endif //#if defined(COMPILE_IQ_TUNING_TOOL_APIS)
    int GetDebugInfo(void *info, int *size);
};

...
/*##### self-defined mouse MSGs by Zhen @ infotm#####*/

#define INFOTMIC_MOUSE_MOVE_UP              0x0001
#define INFOTMIC_MOUSE_MOVE_DOWN            0x0002
#define INFOTMIC_MOUSE_MOVE_LEFT            0x0003
#define INFOTMIC_MOUSE_MOVE_RIGHT           0x0004
#define INFOTMIC_MSG_MOUSE_SLIDING          (MSG_USER + 1)
#define INFOTMIC_MSG_MOUSE_SCROLLING        (MSG_USER + 2)

/*##### self-defined mouse MSGs end #####*/

/*##### self-defined MSGs by Jeason @ infotm#####*/
#define MSG_USER_GET_UI_STATUS		(MSG_USER + 3)
#define MSG_USER_IR_LED				(MSG_USER + 5)
#define MSG_USER_COLLISION			(MSG_USER + 6)
#define MSG_USER_CHARGE_STATUS		(MSG_USER + 10)
#define MSG_USER_BATTERY_STATUS		(MSG_USER + 11)
#define MSG_USER_SDCARD_MOUNT		(MSG_USER + 20)
#define MSG_USER_HDMI_HOTPLUG		(MSG_USER + 30)
#define MSG_USER_REAR_CAMERA		    (MSG_USER + 31)
#define MSG_USER_REVERSE_IMAGE       (MSG_USER + 32)
#define MSG_USER_GPS                 (MSG_USER + 33)
#define MSG_USER_ACC_CONNECT         (MSG_USER + 34)

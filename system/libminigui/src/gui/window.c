...
{
    printf("DefaultDTMouseMsgHandler %d\n", message);
    ...
    printf("DefaultDTMouseMsgHandler, msg:%d\n", message);
...
static int DefaultMouseMsgHandler (PMAINWIN pWin, int message, 
        WPARAM flags, int x, int y)
{
    //printf("DefaultMouseMsgHandler msg:%d, xy:%d-%d\n", message, x, y);
...
//zhl    printf("DefaultNCMouseMsgHandler msg:%d, xy:%d-%d\n", message, x, y);
...
static int DefaultKeyMsgHandler (PMAINWIN pWin, int message, 
        WPARAM wParam, LPARAM lParam)
{printf("DefaultKeyMsgHandler msg:%d, \n", message);
    /*
     ** NOTE:
...
static int DefaultPostMsgHandler(PMAINWIN pWin, int message,
        WPARAM wParam, LPARAM lParam)
{
    if(0)printf("DefaultPostMsgHandler msg:%d, \n", message);
    switch (message)
    {
        case MSG_SETCURSOR:
            /*
...
{
    // 325 / 296/ 178 don't prt
    //if(message!=325 && message!=296 && MSG_NCPAINT !=message)printf("PreDefMainWinProc %s(%d)\n",Message2Str(message), message);
    PMAINWIN pWin = (PMAINWIN)hWnd;

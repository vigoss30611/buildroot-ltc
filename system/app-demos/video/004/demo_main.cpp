 ...
 *
 * Description: Encode 720P and 480P H264 ES Stream with ISP Input Simultaneously
 *
 * Author:
...
void *VencStartStreamProc(void *pThreadPara)
{
   ...
   */
    ...
    for (i = 0; i < u32ChannelNum; i++)
    {
        ...
        sprintf(s8pFileName, "/mnt/sd0/%s_%d_%d_%d.h264", s_VideoChannel[i], i, s32Width, s32Height);

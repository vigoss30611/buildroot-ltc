 ...
 *
 * Description: Encode 720P H264 ES Stream with SmartP Feature
 *
 * Author:
...
void VencSetRateCtrl(EN_VIDEO_RATE_CTRL_TYPE enRatectrlMode)
{
    ...
    stRatectrlInfo.gop_length = 150;
    stRatectrlInfo.idr_interval = 150;
    stRatectrlInfo.refresh_interval = 30;

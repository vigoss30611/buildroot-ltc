...
typedef enum 
{
	...
	IOTYPE_USER_IPCAM_BTCOMMAND_REQ			= 0xAAAA,
	IOTYPE_USER_IPCAM_BTCOMMAND_RESP			= 0xAAAB,
	IOTYPE_USER_IPCAM_BTCOMMAND_RESULT_REQ			= 0xAAAC,
	IOTYPE_USER_IPCAM_BTCOMMAND_RESULT_RESP			= 0xAAAD,
	...
	IOTYPE_USER_CHECK_SD                        = 0x3001,
	IOTYPE_USER_CHECK_SD_RESP                   = 0x3002,

    IOTYPE_USER_SET_WARNING_SOUND_REQ           = 0x3006,
    IOTYPE_USER_SET_WARNING_SOUND_RESP          = 0x3007,

    IOTYPE_USER_IPCAM_OTACOMMAND_REQ            = 0x3008,
    IOTYPE_USER_IPCAM_OTACOMMAND_RESP           = 0x3009,

    /* RM15516: Added by Henry Li 20160121 */
    IOTYPE_USER_IPCAM_GETSPEAKERSTATUS_REQ      = 0x3011,
    IOTYPE_USER_IPCAM_GETSPEAKERSTATUS_RESP     = 0x3012,
    IOTYPE_USER_IPCAM_START_RING	=		0x3015,
	...
	IOTYPE_INFOTM_SETAUDIODETECT_REQ  = 0xff001001,// config audio alarm request.
	IOTYPE_INFOTM_SETAUDIODETECT_RESP = 0xff001002,// config audio alarm response.
	IOTYPE_INFOTM_GETAUDIODETECT_REQ  = 0xff001003,// get config audio alarm request.
	IOTYPE_INFOTM_GETAUDIODETECT_RESP = 0xff001004,// get config audio alarm response.
	IOTYPE_INFOTM_SETTEMPDETECT_REQ   = 0xff001005,// config temprature alarm request.
	IOTYPE_INFOTM_SETTEMPDETECT_RESP  = 0xff001006,// config temprature alarm response.
	IOTYPE_INFOTM_GETTEMPDETECT_REQ   = 0xff001007,// get config temprature alarm request.
	IOTYPE_INFOTM_GETTEMPDETECT_RESP  = 0xff001008,// get config temprature alarm response.
	IOTYPE_INFOTM_SETEMAIL_REQ        = 0xff001009,// config email request.
	IOTYPE_INFOTM_SETEMAIL_RESP       = 0xff00100a,// config email response.
	IOTYPE_INFOTM_GETEMAIL_REQ        = 0xff00100b,// get email config request.
	IOTYPE_INFOTM_GETEMAIL_RESP       = 0xff00100c,// get email config response.
	IOTYPE_INFOTM_SETEMAILENABLE_REQ  = 0xff00100d,// set email enable request.
	IOTYPE_INFOTM_SETEMAILENABLE_RESP = 0xff00100e,// set email enable response.
	IOTYPE_INFOTM_GETEMAILENABLE_REQ  = 0xff00100f,// get email enable request.
	IOTYPE_INFOTM_GETEMAILENABLE_RESP = 0xff001010,// get email enable response.	

    IOTYPE_INFOTM_SETTIME_REQ         = 0xff001011,// Set time request
    IOTYPE_INFOTM_SETTIME_RESP        = 0xff001012,// Set time response
    IOTYPE_INFOTM_GETTIME_REQ         = 0xff001013,// get time request
    IOTYPE_INFOTM_GETTIME_RESP        = 0xff001014,// get time response

	IOTYPE_INFOTM_GETCLOUD_REQ        = 0xff001015,
    IOTYPE_INFOTM_GETCLOUD_RESP       = 0xff001016,
	IOTYPE_INFOTM_SETCLOUD_REQ  	  = 0xff001017,
	IOTYPE_INFOTM_SETCLOUD_RESP 	  = 0xff001018,

    IOTYPE_INFOTM_WIFISTA_OK 	      = 0xff001019, 

    IOTYPE_INFOTM_EMAILTEST_REQ       = 0xff001020,
    IOTYPE_INFOTM_CLOUD_URI_REQ       = 0xff001021, //fengwu 0910
    IOTYPE_INFOTM_CLOUD_URI_RSP       = 0xff001022,
    IOTYPE_INFOTM_WIFI_STA_SSID_REQ   = 0xff001023,
    IOTYPE_INFOTM_WIFI_STA_SSID_RSP   = 0xff001024,
    IOTYPE_INFOTM_REMOVE_ALARM_REQ    = 0xff001025,
    IOTYPE_INFOTM_REMOVE_ALARM_RSP    = 0xff001026,
    IOTYPE_INFOTM_GET_MAC_REQ         = 0xff001027,
    IOTYPE_INFOTM_GET_MAC_RESP        = 0xff001028,
    IOTYPE_INFOTM_PLAYAUDIO_REQ       = 0xff001029,
    IOTYPE_INFOTM_PLAYAUDIO_RESP      = 0xff001030,
    IOTYPE_INFOTM_LED_REQ             = 0xff001031,
    IOTYPE_INFOTM_LED_RESP            = 0xff001032,
    IOTYPE_INFOTM_BURNID_REQ          = 0xff001033,
    IOTYPE_INFOTM_BURNID_RESP         = 0xff001034,
    IOTYPE_INFOTM_JPG_DATA            = 0xff001035,
    IOTYPE_INFOTM_LISTFILE_REQ	      = 0xff001036,
	IOTYPE_INFOTM_LISTFILE_RESP	      = 0xff001037,
	IOTYPE_INFOTM_FILE_PLAYCONTROL_REQ= 0xff001038,
	IOTYPE_INFOTM_FILE_PLAYCONTROL_RESP=0xff001039,
	IOTYPE_INFOTM_REMOVE_FILE_REQ     = 0xff001040,
    IOTYPE_INFOTM_REMOVE_FILE_RSP     = 0xff001041,
    IOTYPE_INFOTM_GETDVMOD_REQ        = 0xff001042, 
    IOTYPE_INFOTM_GETDVMOD_RSP        = 0xff001043,
    IOTYPE_INFOTM_SETDVMOD_REQ        = 0xff001044, 
    IOTYPE_INFOTM_SETDVMOD_RSP        = 0xff001045,
    IOTYPE_INFOTM_RECORD_CTL_REQ      = 0xff001046, //1:start 0:stop
    IOTYPE_INFOTM_RECORD_CTL_RSP      = 0xff001047,
    IOTYPE_INFOTM_BURST_CTL_REQ       = 0xff001048, 
    IOTYPE_INFOTM_BURST_CTL_RSP       = 0xff001049,
    IOTYPE_INFOTM_SETBURSTTYPE_REQ    = 0xff001050, 
    IOTYPE_INFOTM_SETBURSTTYPE_RSP    = 0xff001051,
    IOTYPE_INFOTM_GETBURSTTYPE_REQ    = 0xff001051, 
    IOTYPE_INFOTM_GETBURSTTYPE_RSP    = 0xff001052,
...
typedef enum
{
	...
	AVIOTC_WIFI_CANCEL_SETTING          = 0x04,
}ENUM_AP_MODE;
...
typedef enum 
{
    ...
    AVIOCTRL_EVENT_AUDIODECT            = 0x07,
    AVIOCTRL_EVENT_TEMPDECT             = 0x08,
...
typedef enum
{
	...
	AVIOTC_RECORDTYPE_ALARMSNAP			= 0x04,
}ENUM_RECORD_TYPE;

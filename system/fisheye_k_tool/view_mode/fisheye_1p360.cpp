...
static int p1_gen_griddata(fe_gd_param_t *gd_param_ptr)
{
	int ret = -1;
	int i = 0;
	...
	grid_param.fisheyeStartTheta = 0;
	grid_param.fisheyeEndTheta = 360;
...
static int p1_proc(fe_view_param_t *view_param_ptr)
{
	int ret = 0;

...
/*local parameters*/
// 1R normal
#define VIEW_ID "Barrel"
#define MODE_NAME "mercator"
#define MAX_IDX 1
#define LOCAL_OUT_WIDTH   1920
#define LOCAL_OUT_HEIGHT  1080
#define LOCAL_GRID_SIZE   32
#define LOCAL_ANGLE_UNIT (360 / MAX_IDX)

static int b1r_gen_griddata(fe_gd_param_t *gd_param_ptr)
{
	int ret = -1;
	int i = 0;
	...
	grid_param.fisheyeMode = FISHEYE_MODE_MERCATOR;
	...
	grid_param.fisheyeRadius = 25;

	grid_param.fisheyeStartPhi = -56;
	grid_param.fisheyeEndPhi = 56;
	grid_param.fisheyeStartTheta = -56;
	grid_param.fisheyeEndTheta = 56;

	grid_param.scalingWidth = 1.0;
	grid_param.scalingHeight = 1.0;
	grid_param.fisheyeRotateAngle = 0.0;
...
static int b1r_proc(fe_view_param_t *view_param_ptr)
{
	int ret = 0;

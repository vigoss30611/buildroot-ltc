...
/*local parameters*/
#define VIEW_ID "floor"
#define MODE_NAME "floor"
#define MAX_IDX 90
...
static int fl_gen_griddata(fe_gd_param_t *gd_param_ptr)
{
	int ret = -1;
	int i = 0;
	...
	// 180, 184..., 356, 0, 4 ... 176 (90 sets)
	//This part we could use for-loop to generate 90 sets grid data ever 4 degree
	grid_param.fisheyeRotateAngle = 180;

	grid_param.fisheyeHeadingAngle = 90;
	grid_param.fisheyePitchAngle = 145;
...
static int fl_proc(fe_view_param_t *view_param_ptr)
{
	int ret = 0;

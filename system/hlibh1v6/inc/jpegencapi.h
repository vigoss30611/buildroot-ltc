...
/* Encoding configuration */
   EXPORT JpegEncRet JpegEncSetPictureSize(JpegEncInst inst,
                                     const JpegEncCfg * pEncCfg);

   EXPORT JpegEncRet JpegEncSetThumbnail(JpegEncInst inst,
                                   const JpegEncThumb * JpegThumb);
   EXPORT JpegEncRet JpegEncSetQuality(JpegEncInst inst,
                                   const JpegEncCfg * pEncCfg);
...
/* Jfif generation */
   EXPORT JpegEncRet JpegEncEncodeSyn(JpegEncInst inst,

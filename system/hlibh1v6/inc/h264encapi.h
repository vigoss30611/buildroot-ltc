...
/* Initialization & release */
   EXPORT H264EncRet H264EncInitSyn(const H264EncConfig * pEncConfig,
                           H264EncInst * instAddr);
    H264EncRet H264EncInit(const H264EncConfig * pEncConfig,
                           H264EncInst * instAddr);
   EXPORT H264EncRet H264EncRelease(H264EncInst inst);

/* Encoder configuration before stream generation */
   EXPORT H264EncRet H264EncSetCodingCtrl(H264EncInst inst, const H264EncCodingCtrl *
                                    pCodingParams);
   EXPORT H264EncRet H264EncGetCodingCtrl(H264EncInst inst, H264EncCodingCtrl *
                                    pCodingParams);

/* Encoder configuration before and during stream generation */
   EXPORT H264EncRet H264EncSetRateCtrl(H264EncInst inst,
                                  const H264EncRateCtrl * pRateCtrl);
   EXPORT H264EncRet H264EncGetRateCtrl(H264EncInst inst,
                                  H264EncRateCtrl * pRateCtrl);

   EXPORT H264EncRet H264EncSetPreProcessingSyn(H264EncInst inst,
                                       const H264EncPreProcessingCfg *
                                       pPreProcCfg);
   EXPORT H264EncRet H264EncGetPreProcessingSyn(H264EncInst inst,
...
/* Encoder user data insertion during stream generation */
    EXPORT H264EncRet H264EncSetSeiUserData(H264EncInst inst, const u8 * pUserData,
                                     u32 userDataSize);

/* Stream generation */

/* Set stream link mode */
   EXPORT H264EncRet H264LinkMode(H264EncInst inst, u32 linkMode);
 ...
 */
   EXPORT H264EncRet H264EncStrmStartSyn(H264EncInst inst, const H264EncIn * pEncIn,
                                H264EncOut * pEncOut);
 ...
 */
   EXPORT H264EncRet H264EncStrmEncodeSyn(H264EncInst inst, const H264EncIn * pEncIn,
                                 H264EncOut * pEncOut,
                                 H264EncSliceReadyCallBackFunc cbFunc,
                                 void * pAppData);

/* H264EncStrmEnd ends a stream with an EOS code. */
   EXPORT H264EncRet H264EncStrmEndSyn(H264EncInst inst, const H264EncIn * pEncIn,
                              H264EncOut * pEncOut);

/*Infotm patch*/
EXPORT H264EncRet H264EncCalculateInitialQp(H264EncInst inst, i32 *s32QpHdr, i32 s32BitRate);

EXPORT H264EncRet H264EncGetRealQp(H264EncInst inst, i32 *s32QpHdr);
...
//#define H264EncTrace(msg) fprintf(stderr, msg)

...
#define HX170DEC_MMU_SET           _IOW(HX170DEC_IOC_MAGIC, 9, int)
#define VDEC_NOTIFY_HW_ENABLE      _IOW(HX170DEC_IOC_MAGIC, 10, int)
...
#define HX170DEC_IOCGNV21OFFSET    _IOR(HX170DEC_IOC_MAGIC,  15, unsigned long *)

#define HX170DEC_IOC_MAXNR 15

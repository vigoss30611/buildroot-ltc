...
/* Version information */
    EXPORT JpegDecApiVersion JpegGetAPIVersion(void);

/* Build information */
    EXPORT JpegDecBuild JpegDecGetBuild(void);

/* Initialization */
    EXPORT JpegDecRet JpegDecInit(JpegDecInst * pDecInst, DWLLinearMem_t *pTableBase, u32 mmuEnable);

/* Release */
    EXPORT void JpegDecRelease(JpegDecInst decInst);

/* Get image information of the JFIF */
    EXPORT JpegDecRet JpegDecGetImageInfo(JpegDecInst decInst,
                                   JpegDecInput * pDecIn,
                                   JpegDecImageInfo * pImageInfo);

/* Decode JFIF */
    EXPORT JpegDecRet JpegDecDecode(JpegDecInst decInst,

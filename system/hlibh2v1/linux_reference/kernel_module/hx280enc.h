...
#define HX280ENC_DEFAULT_MAJOR		100
#define HX280ENC_DEFAULT_MINOR		101
#define HX280ENC_MODULE_NAME "hx280enc_drv"
#define HX280ENC_RET_OK		0
#define HX280ENC_RET_ERROR	-1000

//macros about irq, irq register location and someothers
//TODO: double check...
#define HX280ENC_IRQ_STAT_DEC	1
//#define HX280ENC_IRQ_STAT_PP	60

#define HX280ENC_IRQ_BIT	0x100
#define HX280ENC_MEMPOOL_BASE_PA 	(0x21E00000)
#define HX280ENC_MEMPOOL_SIZE 		(0x10000)
#define IRQ_HX280ENC          		(128) /*Infotm video decoder interrupt */
...
#define HX280ENC_IOCG_CORE_OFF     _IO(HX280ENC_IOC_MAGIC, 20)
#define HX280ENC_IOCG_CORE_ON      _IO(HX280ENC_IOC_MAGIC, 21)

...
public class PreviewActivity extends BaseActivity implements Connection.LiveAudioReceiver, DanalePlayer.OnPlayerStateChangeListener, Callback{
...
/*		reSync = (TextView) findViewById(R.id.re_sync);
        ...
        if(mrlay!=null)
        {
			...
			Log.i("PreviewActivity", "height:" + display.getWidth()); 
...
//            startInitConfig(mHandler,mSmartyProgressBar);//在BaseActivty的onresume会触发onNetworkStateUpdate
	...
	private void initData(){
		context = this;
			...
			device = app.getLanDeviceByIp(InfotmCamera.apIP);
			InfotmCamera.currentIP=InfotmCamera.apIP;
			Log.i(tag,"initData:"+InfotmCamera.apIP);
			if(device!=null)
		    {
		    ...
		    }else
		    {
				...
				device.setDeviceType(deviceType);
				device.setIp(InfotmCamera.apIP);
				device.setNetmask(netmask);
				device.setP2pPort(p2pPort);
				device.setSn(sn);
				connection = device.getConnection();
...
//            	RecordActivity.startActivity(context, device.getDeviceId(), channel, DeviceType.IPC, System.currentTimeMillis(), 10);
                Intent browserIntent = new Intent(PreviewActivity.this, FolderBrowserActivity.class);
        ...
        mBtnSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PreviewActivity.this, CameraSettingsActivity.class);
    ...
    public void showMoreDialog(){
    	...
    	mMoreDialog.findViewById(R.id.phone_media).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				String storedSsid = mPref.getString("wifi", null);
    			Intent intent= new Intent(PreviewActivity.this, PhoneLocalMediaDeviceActivity.class) ;
    	...
    	mQualityRearView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
		        ...
		        connection.setVideoQuality(0, channel, videoQuality, new DeviceResultHandler() {
		            @Override
		            public void onSuccess(DeviceResult result) {
		            	Toast.makeText(PreviewActivity.this, "Rear", 2000).show();
		            }
	    			...
	    			Toast.makeText(PreviewActivity.this, R.string.rear_camera_not_insert_str, 2000).show();
	    		}
    	...
    	mQualityOriginView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
		        ...
		        connection.setVideoQuality(0, channel, videoQuality, new DeviceResultHandler() {
		            @Override
		            public void onSuccess(DeviceResult result) {
		            	Toast.makeText(PreviewActivity.this, "Origin", 2000).show();
		            }
    	...
    	mQualitySmoothView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
		        ...
		        connection.setVideoQuality(0, channel, videoQuality, new DeviceResultHandler() {
		            @Override
		            public void onSuccess(DeviceResult result) {
		            	Toast.makeText(PreviewActivity.this, "Smooth", 2000).show();
		            }

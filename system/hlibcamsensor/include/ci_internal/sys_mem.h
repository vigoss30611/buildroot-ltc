 ...
 *
 * Not used at the moment - using default IMGMMU read function. Add to
 * KRN_CI_MMUDirCreate() if needed
 *
IMG_UINT32 Platform_MMU_MemPageRead(struct MMUPage *pReadFrom,
    unsigned int offset);*/

/**
 * @brief Function to invalid CPU caches of MMU pages to ensure device can
 * access them
 *
 * Should implement IMGMMU_pfnPageUpdate
 */

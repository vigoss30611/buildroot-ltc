...
#ifndef _STK3855DUAL720DVP_
#define _STK3855DUAL720DVP_
...
#define STK3855DUAL720DVP_SPECIAL_MODE 0xFF

/**
 * @ingroup SENSOR_API
 */
IMG_RESULT STK3855DUAL720DVP_Create(struct _Sensor_Functions_ **hHandle, int index);

/**
 * @brief Load registers from a file as the special mode STK3855DUAL720DVP_SPECIAL_MODE
 * @ingroup SENSOR_API
 *
 * This allow to specify registers for the STK3855DUAL720DVP at run time instead of
 ...
 */
IMG_RESULT STK3855DUAL720DVP_LoadSpecialModeRegisters(struct _Sensor_Functions_ *hHandle,
    const char *filename);

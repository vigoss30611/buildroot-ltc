 ...
 * @ingroup SENSOR_API
 */
IMG_RESULT AR330DVP_Create(struct _Sensor_Functions_ **hHandle, int index);

/**
 * @brief Load registers from a file as the special mode AR330DVP_SPECIAL_MODE
 * @ingroup SENSOR_API
 *
 * This allow to specify registers for the AR330DVP at run time instead of

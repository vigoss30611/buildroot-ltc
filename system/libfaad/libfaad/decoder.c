                              ...
                              unsigned char *channels)
{
    ...
    *samplerate = get_sample_rate(hDecoder->sf_index);
	printf("samplerate=%d,hDecoder->sf_index=%d\n",*samplerate,hDecoder->sf_index);
    *channels = 1;
    ...
    if (buffer != NULL)
    {
			...
			(buffer[2] == 'I') && (buffer[3] == 'F'))
		{
            ...
            *samplerate = get_sample_rate(hDecoder->sf_index);
				printf("2samplerate=%d,hDecoder->sf_index=%d\n",*samplerate,hDecoder->sf_index);
        ...
        /* Check if an ADTS header is present */
            ...
            *samplerate = get_sample_rate(hDecoder->sf_index);
		   printf("3samplerate=%d,hDecoder->sf_index=%d,adts.channel_configuration=%d\n",*samplerate,hDecoder->sf_index,adts.channel_configuration);
    ...
    {
        *samplerate *= 2;
			printf("4samplerate=%d,hDecoder->sf_index=%d\n",*samplerate,hDecoder->sf_index);

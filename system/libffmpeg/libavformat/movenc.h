...
#define MOV_TIMECODE_FLAG_ALLOWNEGATIVE 0x0004
    ...
    /*
    *modify container .mp4 fourcc "trak" to "infv" to support infotm private track
    0 means default "trak"
    none zero "infv"
    */
    int  private_control_flag;
} MOVTrack;
...
typedef struct MOVMuxContext {
    ...
    /*
    *modify container .mp4 fourcc "trak" to "infv" to support infotm private track only video track
    each bit notify one track enable/disable
    Ex:3 video track with  private_control_flag : 0x6 = 0110  means track 0 "trak" track 1 and track 2 set "infv"
    */
    int private_control_flag;

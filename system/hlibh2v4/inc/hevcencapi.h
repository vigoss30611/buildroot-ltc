...
#ifdef __GNUC__
#define API_EXPORT __attribute__((visibility("default")))   //just for gcc4+
#else
#define API_EXPORT  __declspec(dllexport)
  ...
  ------------------------------------------------------------------------------*/
  /* Version information */
  API_EXPORT HEVCEncApiVersion HEVCEncGetApiVersion(void);
  API_EXPORT HEVCEncBuild HEVCEncGetBuild(void);

  /* Helper for input format bit-depths */
  u32 HEVCEncGetBitsPerPixel(HEVCEncPictureType type);

  /* Initialization & release */
  API_EXPORT HEVCEncRet HEVCEncInit(HEVCEncConfig *config, HEVCEncInst *instAddr);
  API_EXPORT HEVCEncRet HEVCEncRelease(HEVCEncInst inst);
  ...
  API_EXPORT HEVCEncRet HEVCEncSetCodingCtrl(HEVCEncInst instAddr, const HEVCEncCodingCtrl *pCodeParams);
  API_EXPORT HEVCEncRet HEVCEncGetCodingCtrl(HEVCEncInst inst,
                                  HEVCEncCodingCtrl *pCodeParams);

  /* Encoder configuration before and during stream generation */
  API_EXPORT HEVCEncRet HEVCEncSetRateCtrl(HEVCEncInst inst, const HEVCEncRateCtrl *pRateCtrl);
  API_EXPORT HEVCEncRet HEVCEncGetRateCtrl(HEVCEncInst inst, HEVCEncRateCtrl *pRateCtrl);

  API_EXPORT HEVCEncRet HEVCEncSetPreProcessing(HEVCEncInst inst, const HEVCEncPreProcessingCfg *pPreProcCfg);
  API_EXPORT HEVCEncRet HEVCEncGetPreProcessing(HEVCEncInst inst,
                                     HEVCEncPreProcessingCfg *pPreProcCfg);

  /* Encoder user data insertion during stream generation */
  API_EXPORT HEVCEncRet HEVCEncSetSeiUserData(HEVCEncInst inst, const u8 *pUserData,
                                   u32 userDataSize);
   ...
   */
  API_EXPORT HEVCEncRet HEVCEncStrmStart(HEVCEncInst inst, const HEVCEncIn *pEncIn,
                              HEVCEncOut *pEncOut);
   ...
   */
  API_EXPORT HEVCEncRet HEVCEncStrmEncode(HEVCEncInst inst, const HEVCEncIn *pEncIn,
                               HEVCEncOut *pEncOut,
  ...
  API_EXPORT HEVCEncRet HEVCEncStrmEnd(HEVCEncInst inst, const HEVCEncIn *pEncIn,
                            HEVCEncOut *pEncOut);

  API_EXPORT HEVCEncRet HEVCEncCalculateInitialQp(HEVCEncInst inst, i32 *s32QpHdr, i32 s32BitRate);

  API_EXPORT HEVCEncRet HEVCEncGetRealQp(HEVCEncInst inst, i32 *s32QpHdr);

...
static void profile_and_level(struct buffer *b, i32 max_num_sub_layers, u32 profile,u32 level, HEVCEncInst inst);
...
void video_parameter_set(struct vps *v, HEVCEncInst inst)
{
  ...
  profile_and_level(b, v->max_num_sub_layers,v->general_profile_idc, v->general_level_idc, inst);
...
/*------------------------------------------------------------------------------
  profile_and_level
------------------------------------------------------------------------------*/
void profile_and_level(struct buffer *b, i32 max_num_sub_layers, u32 profile,u32 level, HEVCEncInst inst)
{
  struct hevc_instance *hevc_instance = (struct hevc_instance *)inst;
...
void sequence_parameter_set(struct container *c, struct sps *s, HEVCEncInst inst)
{
  ...
  profile_and_level(b, s->max_num_sub_layers, s->general_profile_idc,s->general_level_idc, inst);

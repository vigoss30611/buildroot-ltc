...
int main (int argc, char **argv)
{
    ...
    zbar_image_scanner_set_config(scanner, ZBAR_QRCODE, ZBAR_CFG_UNCERTAINTY, 22);
//    zbar_image_scanner_set_config(scanner, ZBAR_QRCODE, ZBAR_CFG_ADD_CHECK, 1);
//    zbar_image_scanner_set_config(scanner, ZBAR_QRCODE, ZBAR_CFG_EMIT_CHECK, 1);
    zbar_image_scanner_set_config(scanner, ZBAR_QRCODE, ZBAR_CFG_MIN_LEN, 0);
    zbar_image_scanner_set_config(scanner, ZBAR_QRCODE, ZBAR_CFG_MAX_LEN, 0x300000);

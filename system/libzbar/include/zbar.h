 ...
 */
EXPORT extern const char *zbar_get_symbol_name(zbar_symbol_type_t sym);
 ...
 */
EXPORT extern zbar_symbol_type_t zbar_symbol_get_type(const zbar_symbol_t *symbol);
 ...
 */
EXPORT extern const char *zbar_symbol_get_data(const zbar_symbol_t *symbol);
 ...
 */
EXPORT extern const zbar_symbol_t *zbar_symbol_next(const zbar_symbol_t *symbol);
 ...
 */
EXPORT extern zbar_image_t *zbar_image_create(void);
 ...
 */
EXPORT extern void zbar_image_destroy(zbar_image_t *image);
 ...
 */
EXPORT extern const zbar_symbol_t*
 ...
 */
EXPORT extern void zbar_image_set_format(zbar_image_t *image,
                                  unsigned long format);
 ...
 */
EXPORT extern void zbar_image_set_size(zbar_image_t *image,
                                unsigned width,
                                unsigned height);
 ...
 */
EXPORT extern void zbar_image_set_data(zbar_image_t *image,
                                const void *data,
...
/** constructor. */
EXPORT extern zbar_image_scanner_t *zbar_image_scanner_create(void);

/** destructor. */
EXPORT extern void zbar_image_scanner_destroy(zbar_image_scanner_t *scanner);
 ...
 * @since 0.4
 */
EXPORT extern int zbar_image_scanner_set_config(zbar_image_scanner_t *scanner,
                                         zbar_symbol_type_t symbology,
                                         zbar_config_t config,
                                         int value);
 ...
 */
EXPORT extern int zbar_scan_image(zbar_image_scanner_t *scanner,
                           zbar_image_t *image);

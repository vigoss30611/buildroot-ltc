...
int audio_route_cget(channel_t dev, char *route, char *value)
{
	int err;
	snd_ctl_elem_info_t *info;
	snd_ctl_elem_id_t *id;
...
int audio_route_cset(channel_t dev, char *route, char *value)
{
	int err;
...
int audio_open_ctl(channel_t dev)
{
	int ret;
...
void audio_close_ctl(channel_t dev)
{

...
/* Mixer control names */
#define MIXER_MASTER_PLAYBACK_VOLUME    "Front Playback Volume"
#define MIXER_MASTER_PLAYBACK_SWITCH    "Front Playback Switch"
#define MIXER_PCM_PLAYBACK_VOLUME       "PCM Playback Volume"
#define MIXER_PCM_PLAYBACK_SWITCH       "PCM Playback Switch"
#define MIXER_CAPTURE_SOURCE            "Input Source"
                     ...
                     hw_device_t** device)
{
    ...
    adev->hw_device.common.version = AUDIO_DEVICE_API_VERSION_2_0;//AUDIO_DEVICE_API_VERSION_1_0;

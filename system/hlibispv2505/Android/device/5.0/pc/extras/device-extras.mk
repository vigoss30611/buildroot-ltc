PRODUCT_COPY_FILES += \
	device/img/pc/extras/conf/init.pc_extras_gps.rc:root/init.pc_extras_gps.rc \
...
ifeq ($(BOARD_WIFI),WiredWifi)
PRODUCT_COPY_FILES += \
	device/img/pc/extras/wifi-setup.sh:root/wifi-setup.sh \
	device/img/pc/extras/wpa_supplicant.conf:data/misc/wifi/wpa_supplicant.conf \
	device/img/pc/extras/dhcpcd.conf:system/etc/dhcpcd/dhcpcd.conf
endif

ifeq ($(BOARD_WIFI),Wifi)
PRODUCT_COPY_FILES += \
	device/img/pc/extras/conf/init.pc_extras_wifi.rc:root/init.pc_extras_wifi.rc
PRODUCT_PACKAGES += \
	wpa_supplicant \
	wpa_supplicant.conf
endif

# If the user has kernel/rtl8188eu checked out and built, copy the .ko
# into the system image.
#ifneq ($(wildcard kernel/rtl8188eu/8188eu.ko),)
#PRODUCT_COPY_FILES += \
#	kernel/rtl8188eu/8188eu.ko:system/modules/8188eu.ko \
#	kernel/rtl8188eu/rtl8188eufw.bin:system/etc/firmware/rtlwifi/rtl8188eufw.bin
#endif

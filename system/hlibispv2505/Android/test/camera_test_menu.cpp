...
pixel_format pixelformat[] = {
  { HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, "Implementation defined" },
...
const char *codingformat[] = {"impl. def.", "rgba8888", "yuv422i-yuyv", "yuv420sp", "rgb565", "jpeg", "raw", "jps", "mpo", "raw+jpeg", "raw+mpo"};

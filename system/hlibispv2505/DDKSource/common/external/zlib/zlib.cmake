...
if(MSVC)
  ...
  # Force /MACHINE
  set(ZLIB_PATCH_COMMAND ${CMAKE_COMMAND} -E chdir . ${ZLIB_PREFIX}/patch/win32/CMakeListsPatch.bat)
endif()
...
if(MINGW)
  ...
  set(ZLIB_PATCH_COMMAND ${CMAKE_COMMAND} -E chdir <SOURCE_DIR> patch -p0 -i ${ZLIB_PREFIX}/patch/mingw/CMakeLists.patch)
endif()
...
if(${CMAKE_SYSTEM_NAME} MATCHES "Linux" OR ${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
  ...
  if(APPLE)
    set(ZLIB_PATCH_COMMAND ${CMAKE_COMMAND} -E chdir <SOURCE_DIR> patch -p0 -i ${ZLIB_PREFIX}/patch/darwin/CMakeLists.patch)
  endif()  

  if(META)
    set(ZLIB_PATCH_COMMAND ${CMAKE_COMMAND} -E chdir <SOURCE_DIR> patch -p0 -i ${ZLIB_PREFIX}/patch/meta/CMakeLists.patch)
  endif()
endif()

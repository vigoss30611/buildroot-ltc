 ...
 * @code
	...
	if ( List_create(&pList) != IMG_SUCCESS ) return EXIT_FAILURE;
	// add things to the list
	List_clear(pList);
	IMG_FREE(pList); @endcode
 */
typedef struct LinkedList_T {
  ...
  IMG_UINT32 ui32Elements; /**< @brief Number of elements currently in the list */
 ...
 *
 * @return IMG_SUCCESS
 * @return IMG_ERROR_INVALID_PARAMETERS if ppList is NULL
 * @return IMG_ERROR_MEMORY_IN_USE if *ppList is NOT NULL
 * @return IMG_ERROR_MALLOC_FAILED if malloc of the list failed
 */
 ...
 *
 * @param pList pointer to the list to initialise
 * @param ui32nelem number of elements in the pool
 ...
 *
 * @return IMG_SUCCESS
 * @return IMG_ERROR_INVALID_PARAMETERS if the pList is NULL
 *
 ...
 *
 * @return IMG_SUCCESS
 * @return IMG_ERROR_INVALID_PARAMETERS if the pList or pfnDestructor are NULL
 *
 * @see List_free()
 */
 ...
 *
 * @return IMG_SUCCESS
 * @return IMG_ERROR_MALLOC_FAILED if the allocation of the cell failed
 * @return IMG_ERROR_INVALID_PARAMETER if pList is NULL
 * @return Or any return code from its delegate functions
 *
 ...
 * @param elem the element to push in the list - NULL is allowed.
 *
 * @return IMG_SUCCESS if the element is added
 * @return IMG_ERROR_MALLOC_FAILED if the allocation of the cell failed
 * @return IMG_ERROR_INVALID_PARAMETER if pList is NULL
 * @return Or any return code from its delegate functions
 *
 ...
 *
 * @return IMG_SUCCESS
 * @return IMG_ERROR_UNEXPECTED_STATE if the element is attached to another list - detach it first.
 *
 * @see List_pushFront()
 */
 ...
 * @param pCell orphan cell
 *
 * @return IMG_SUCCESS if the element is not yet attached to a list
 * @return IMG_ERROR_UNEXPECTED_STATE if the element is attached to another list - detach it first.
 *
 * @see List_pushBack
 */
 ...
 *
 * @return IMG_SUCCESS
 * @return IMG_ERROR_INVALID_PARAMETER if the element is attached to another list - detach it first.
 */
 ...
 *
 * @return IMG_SUCCESS
 * @return IMG_ERROR_INVALID_PARAMETER if pCell or pfnDestructor are NULL
 * @return Or return code for its delegate functions.
 *
 ...
 *
 * @return IMG_TRUE if pList is NULL
 */
...
/**
  ...
  * @param pfnVisitor gives the element from the list as 1st parameter and element as 2nd. It returns IMG_TRUE if the visitor can continue its run through the list. 
  *

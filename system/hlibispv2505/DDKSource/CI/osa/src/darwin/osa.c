...
#if (__MAC_OS_X_VERSION_MIN_REQUIRED >= __MAC_10_6) || (__IPHONE_OS_VERSION_MIN_REQUIRED >= __IPHONE_3_2)
    pthread_setname_np(pFuncParamPair->pszName);//set thread name, to see it use "ps -Leo comm"
#endif

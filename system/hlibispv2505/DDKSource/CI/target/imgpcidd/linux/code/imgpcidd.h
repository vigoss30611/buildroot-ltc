...
/* The ioctl number for this device -  - should be chosen better and registered (check ioctl-number.txt for more info) */
...
#define IMGPCI_IOCTL_META_L2_CACHE_FLUSH _IOW (IMGPCI_IOCTL_MAGIC, 7, struct imgpci_cache_flush *)
#endif /* defined(METAC_2_1) */

/* Max command number */
#if defined(METAC_2_1)
#define IMGPCI_IOCTL_MAXNR			7
#else

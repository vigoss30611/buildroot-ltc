/*!
******************************************************************************
@file   : /home/jenkins/builds/workspace/ISP_PKG/build/CI/felix/regdefs2.7/regdefs//hw_struct/ctx_pointers.h
...
/* FELIX_LINK_LIST, SAVE_CONFIG_FLAGS, AWS_ENABLE
*/
#define FELIX_LINK_LIST_SAVE_CONFIG_FLAGS_AWS_ENABLE_MASK		(0x20000000)
#define FELIX_LINK_LIST_SAVE_CONFIG_FLAGS_AWS_ENABLE_LSBMASK		(0x00000001)
#define FELIX_LINK_LIST_SAVE_CONFIG_FLAGS_AWS_ENABLE_SHIFT		(29)
#define FELIX_LINK_LIST_SAVE_CONFIG_FLAGS_AWS_ENABLE_LENGTH		(1)
#define FELIX_LINK_LIST_SAVE_CONFIG_FLAGS_AWS_ENABLE_DEFAULT		(0)
#define FELIX_LINK_LIST_SAVE_CONFIG_FLAGS_AWS_ENABLE_SIGNED_FIELD	(IMG_FALSE)

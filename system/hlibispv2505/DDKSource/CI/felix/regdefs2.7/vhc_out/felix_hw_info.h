...
/**
 * @}
 * @name WBC: White Balance Clipping (HW 2.6)
 * @{
 */

#define WBC_CHANNEL_NO 3
#define WBC_AVAILABLE 1
...
/** @brief tone mapper min output Y value (fixed for 10 bits) */
#define TNM_OUT_MIN_Y 0
/** @brief tone mapper min output Y value (fixed for 10 bits) */
#define TNM_OUT_MAX_Y 255
/** @brief tone mapper min output chroma value (fixed for 10 bits) */
#define TNM_OUT_MIN_C 0
/** @brief tone mapper min output chroma value (fixed for 10 bits) */
//#define TNM_OUT_MAX_C 205
  #ifdef INFOTM_9080_HM2131_PROJECT
#define TNM_OUT_MAX_C 190
  #else
#define TNM_OUT_MAX_C 195
  #endif
#else
#define TNM_OUT_MIN_Y 10
/** @brief tone mapper min output Y value (fixed for 10 bits) */
#define TNM_OUT_MAX_Y 250
/** @brief tone mapper min output chroma value (fixed for 10 bits) */
#define TNM_OUT_MIN_C 10
/** @brief tone mapper min output chroma value (fixed for 10 bits) */
...
/**
 * @}
 * @name AWS: Auto-White balance statistics (HW 2.6)
 * @{
 */

/** @brief Number of auto white balance tiles */
#define AWS_NUM_GRID_TILES_HORIZ        7
/** @brief Number of auto white balance tiles */
#define AWS_NUM_GRID_TILES_VERT         7
/** @brief Minimum tile size in pixels */
#define AWS_MIN_GRID_TILE_WIDTH (8 * CI_CFA_WIDTH)
/** @brief Minimum tile size in pixels */
#define AWS_MIN_GRID_TILE_HEIGHT (8 * CI_CFA_WIDTH)

/** @brief Sum of red components of AWS collected CFAs. u'27.5 */
#define AWS_COLLECTED_R_INT 27
#define AWS_COLLECTED_R_FRAC 5
#define AWS_COLLECTED_R_SIGNED 0

/** @brief Sum of green components of AWS collected CFAs. u'27.5 */
#define AWS_COLLECTED_G_INT 27
#define AWS_COLLECTED_G_FRAC 5
#define AWS_COLLECTED_G_SIGNED 0

/** @brief Sum of blue components of AWS collected CFAs. u'27.5 */
#define AWS_COLLECTED_B_INT 27
#define AWS_COLLECTED_B_FRAC 5
#define AWS_COLLECTED_B_SIGNED 0

/** @brief Total number of AWS collected CFAs. u'22.0 */
#define AWS_NUM_CFAS_INT 22
#define AWS_NUM_CFAS_FRAC 0
#define AWS_NUM_CFAS_SIGNED 0

/** @brief number of line segments in the AWS curve coeffs and offsets */
#define AWS_LINE_SEG_N 5
#define AWS_LINE_SEG_AVAILABLE

#define AWS_AVAILABLE 1

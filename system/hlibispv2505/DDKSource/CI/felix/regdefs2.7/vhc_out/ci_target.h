...
static TAL_sMemSpaceInfo gasMemSpaceInfo[] =
{
...

    {
        ...
        TAL_MEMSPACE_REGISTER,  /* Memory space type */
        {
            ...
            TAL_NO_IRQ  /* The interrupt number - or TAL_NO_IRQ */
        }
    },
    ...
    // SCB (I2C)
    {
        "REG_TEST_SCB",  /* Memory space name */
        TAL_MEMSPACE_REGISTER,  /* Memory space type */
        {
            0x0000015000,  /* Base address of device registers */
            0x00000000FF,  /* Size of device register block */
            TAL_NO_IRQ  /* The interrupt number - or TAL_NO_IRQ */
        }
    },
    ...
    // Gasket PHY (outside Felix, debug only)
    {
        "REG_GASK_PHY_0",  /* Memory space name */
        TAL_MEMSPACE_REGISTER,  /* Memory space type */
        {
            0x0000016000,  /* Base address of device registers */
            0x00000001FF,  /* Size of device register block */
            TAL_NO_IRQ  /* The interrupt number - or TAL_NO_IRQ */
        }
    },
    ...
    // external Test IO registers
    {
        ...
        TAL_MEMSPACE_REGISTER,  /* Memory space type */
        {
            0x0000014000,  /* Base address of device registers */
            0x00000000FF,  /* Size of device register block */
            0  /* The interrupt number - or TAL_NO_IRQ */
        }
    },

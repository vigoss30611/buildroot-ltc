 ...
 */
extern IMG_RESULT IIFDG_Create(struct _Sensor_Functions_ **phHandle);
 ...
 */
extern IMG_RESULT IIFDG_ExtendedSetConnection(struct _Sensor_Functions_ *hHandle, struct CI_CONNECTION* conn);
 ...
 */
extern IMG_RESULT IIFDG_ExtendedSetSourceFile(struct _Sensor_Functions_ *hHandle, const char *filename);
/**
 ...
 */
extern IMG_RESULT IIFDG_ExtendedGetSourceFile(struct _Sensor_Functions_ *hHandle, const char **filename);

extern IMG_RESULT IIFDG_ExtendedSetGasket(struct _Sensor_Functions_ *hHandle, IMG_UINT8 ui8Gasket);
extern IMG_RESULT IIFDG_ExtendedGetGasket(struct _Sensor_Functions_ *hHandle, IMG_UINT8 *pGasket);

extern IMG_RESULT IIFDG_ExtendedSetDatagen(struct _Sensor_Functions_ *hHandle, IMG_UINT8 ui8Context);
extern IMG_RESULT IIFDG_ExtendedGetDatagen(struct _Sensor_Functions_ *hHandle, IMG_UINT8 *pContext);
 ...
 */
extern IMG_RESULT IIFDG_ExtendedSetFrameCap(struct _Sensor_Functions_ *hHandle, IMG_UINT32 ui32FrameCap);
/**
 ...
 */
extern IMG_RESULT IIFDG_ExtendedGetFrameCap(struct _Sensor_Functions_ *hHandle, IMG_UINT32 *pFrameCap);

/**
 * @brief Access to the frame number that will be loaded next [read-only]
 */
extern IMG_UINT32 IIFDG_ExtendedGetFrameNO(struct _Sensor_Functions_ *hHandle);

/**
 * @brief Access to the number of frames available in the selected source [read-only]
 */
extern IMG_UINT32 IIFDG_ExtendedGetFrameCount(struct _Sensor_Functions_ *hHandle);

extern IMG_RESULT IIFDG_ExtendedSetIsVideo(struct _Sensor_Functions_ *hHandle, IMG_BOOL8 bIsVideo);
extern IMG_RESULT IIFDG_ExtendedGetIsVideo(struct _Sensor_Functions_ *hHandle, IMG_BOOL8 *pIsVideo);

extern IMG_RESULT IIFDG_ExtendedSetNbBuffers(struct _Sensor_Functions_ *hHandle, IMG_UINT32 ui32NBuffers);
extern IMG_RESULT IIFDG_ExtendedGetNbBuffers(struct _Sensor_Functions_ *hHandle, IMG_UINT32 *pNBuffers);

extern IMG_RESULT IIFDG_ExtendedSetBlanking(struct _Sensor_Functions_ *hHandle, IMG_UINT32 ui32HBlanking, IMG_UINT32 ui32VBlanking);
extern IMG_RESULT IIFDG_ExtendedGetBlanking(struct _Sensor_Functions_ *hHandle, IMG_UINT32 *pHBlanking, IMG_UINT32 *pVBlanking);

extern IMG_RESULT IIFDG_ExtendedSetPreload(SENSOR_HANDLE hHandle, IMG_BOOL8 bPreload);
extern IMG_RESULT IIFDG_ExtendedGetPreload(SENSOR_HANDLE hHandle,
    IMG_BOOL8 *pbPreload);

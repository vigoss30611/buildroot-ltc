...
void VisionLive::HWInfo::initHWInfo()
{
	...
	addEntry(tr("The number of vertical taps used by the encoder scaler for the luma component"), QString::number(0));
	addEntry(tr("The number of vertical taps used by the encoder scaler for the chroma component"), QString::number(0));
	...
	for(int i = 0; i < CI_N_IMAGERS; i++)
	{
		...
		addEntry(tr("Combinations of CI_GASKETTYPE [") + QString::number(i) + "]", QString::number(0));
    ...
    addEntry(tr("Device MMU RevMajor"), QString::number(0));
    addEntry(tr("Device MMU RevMinor"), QString::number(0));
    addEntry(tr("Device MMU RevMaint"), QString::number(0));
...
void VisionLive::HWInfo::HWInfoReceived(CI_HWINFO hwInfo)
{
    ...
    params[52]->setSpecialValueText(QString::number(hwInfo.mmu_ui8Enabled));
    params[53]->setSpecialValueText(QString::number(hwInfo.mmu_ui32PageSize));
    params[54]->setSpecialValueText(QString::number(hwInfo.mmu_ui8RevMajor));
    params[55]->setSpecialValueText(QString::number(hwInfo.mmu_ui8RevMinor));
    params[56]->setSpecialValueText(QString::number(hwInfo.mmu_ui8RevMaint));

	params[57]->setSpecialValueText(QString::number(hwInfo.ui32RefClockMhz));
}

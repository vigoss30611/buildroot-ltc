...
/** @brief Overload to save 8 bit int value as string instead of ascii char */
template <>
...
/** @brief Overload to load boolean from 1 or 0 as int */
template <> char parse<char>(const std::string &str, bool &isOk);
...
private:
    ...
    /**
     * @brief parameterInfo field used for tag description
     */
    std::string info;
...
public:
    ...
    /**
     * @brief set additional info for parameter
     *
     * @note used for tag description string
     */
    Parameter& setInfo(const std::string& info);

    /**
     * @brief get additional info for parameter
     *
     * @note used for tag description string
     */
    ...
    /**
     * @brief iterator pointing past the last value
     */
...
public:
    ...
    /**
     * @brief Get const reference to vector of values
     */
 ...
 */
template <typename T>
struct ParamDefArray: ParamAbstract<ParamDefArray<T> >
{
    T min;
    T max;
    T *def;
    ...
    ParamDefArray<T>& operator=(const ParamDefArray<T> &d)
    {
...
std::string getParameterInfo(const ParamDef<short int> &t);
/** @copydoc getParameterInfo(const ParamDef<int> &t) */
...
/** @copydoc getParameterInfo(const ParamDef<int> &t) */
std::string getParameterInfo(const ParamDefArray<short int> &t);
/** @copydoc getParameterInfo(const ParamDef<int> &t) */

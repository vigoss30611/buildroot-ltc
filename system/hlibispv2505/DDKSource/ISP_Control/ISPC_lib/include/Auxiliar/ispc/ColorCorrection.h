...
public:
    ...
    double temperature;
    /** @brief false if no meaningful data, true otherwise */
    bool initialized;
     ...
     */
    ColorCorrection blend(const ColorCorrection &otherCorrection,
    ...
    /**
     * @brief return true if color correction was initialized with meaningful
     * data
     */
    inline bool isValid(void) const { return initialized; }

    /**
     * @brief mark object as initialized with meaningful data
     */
    inline void setValid(void) { initialized = true; }
};

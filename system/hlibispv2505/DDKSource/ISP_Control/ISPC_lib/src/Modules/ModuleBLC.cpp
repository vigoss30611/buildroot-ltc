...
IMG_RESULT ISPC::ModuleBLC::save(ParameterList &parameters, SaveType t) const
{
    ...
    case SAVE_VAL:
        ...
        parameters.addParameter(BLC_SENSOR_BLACK, values);
        parameters.addParameter(BLC_SYS_BLACK, (int)this->ui32SystemBlack);
        break;

    case SAVE_MIN:

        parameters.addParameterMin(BLC_SENSOR_BLACK);
        parameters.addParameterMin(BLC_SYS_BLACK);
        break;

    case SAVE_MAX:

        parameters.addParameterMax(BLC_SENSOR_BLACK);
        parameters.addParameterMax(BLC_SYS_BLACK);
        break;
    ...
    case SAVE_DEF:
        ...
        parameters.addParameterDef(BLC_SENSOR_BLACK);
        parameters.addParameterDef(BLC_SYS_BLACK);

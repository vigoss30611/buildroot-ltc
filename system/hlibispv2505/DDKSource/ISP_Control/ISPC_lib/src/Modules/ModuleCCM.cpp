...
IMG_RESULT ISPC::ModuleCCM::save(ParameterList &parameters, SaveType t) const
{
    ...
    case SAVE_VAL:
        ...
        parameters.addParameter(CCM_MATRIX, values);
        ...
        parameters.addParameter(CCM_OFFSETS, values);
        break;

    case SAVE_MIN:
        parameters.addParameterMin(CCM_MATRIX);
        parameters.addParameterMin(CCM_OFFSETS);
        break;

    case SAVE_MAX:
        parameters.addParameterMax(CCM_MATRIX);
        parameters.addParameterMax(CCM_OFFSETS);
        break;

    case SAVE_DEF:

        parameters.addParameterDef(CCM_MATRIX);
        parameters.addParameterDef(CCM_OFFSETS);
        break;
    }

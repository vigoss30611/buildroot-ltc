...
extern uint8_t _usbresv[];
//static unsigned char usb_stor_buf[512];
static unsigned char *usb_stor_buf = (unsigned char *)_usbresv;
static ccb usb_ccb;
...
static block_dev_desc_t *usb_dev_desc = (block_dev_desc_t *)(_usbresv + 512);
...
static struct us_data *usb_stor = (struct us_data *)(_usbresv + 512 + USB_MAX_STOR_DEV * sizeof(block_dev_desc_t));

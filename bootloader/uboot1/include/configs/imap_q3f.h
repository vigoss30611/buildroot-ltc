...
#define CONFIG_DW_MMC_280

#define CONFIG_IROM_VERSION 2885

/*follow define for q3 apollo mmc boot define*/
#define CONFIG_SYS_DISK_iNAND
#define iNAND_CHANNEL  0
//#define BOOT_MMC1

//#define CONFIG_IMAPX_FPGATEST
/*
...
#define PHYS_SDRAM_1_SIZE		0x4000000		/* 256 MB in Bank #1 */
...
#define CONFIG_SYS_PHY_RD_BASE		(CONFIG_SYS_SDRAM_BASE + PHYS_SDRAM_1_SIZE - 0x1000000)
...
#define CONFIG_EXTRA_ENV_SETTINGS "stdin=serial\0"  \
                                  ...
                                  "bootargs=console=ttyAMA3,115200 rootfstype=squashfs root=/dev/spiblock1 rw  serialno=iMAPb1c2a1a3\0"  \
                                  "bootcmd=vs read kernel0 40007fc0 0 300000; bootm 40007fc0\0"  \
                                  //"bootargs=console=ttyAMA3,115200 rootfstype=squashfs root=/dev/mtdblock5 rw mtdparts=nor_flash:48k@0(u-boot0)ro,16k@0xc000(items)ro,64k@0x10000(env),512k@0x20000(uboot1),2560k@0xa0000(kernel0),8000k@0x320000(system) serialno=iMAPb1c2a1a3\0"  \
                                  "verify=no\0"  \
                                  "bootcmd=vs read 40007fc0 a0000 300000; bootm 40007fc0\0"  \

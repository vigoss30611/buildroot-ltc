...
#define MAC_SYSM_RESET				(MAC_SYSM_ADDR + 0x0)
#define MAC_SYSM_CLK_EN				(MAC_SYSM_ADDR + 0x4)
#define MAC_SYSM_POWM 				(MAC_SYSM_ADDR + 0x8)
#define MAC_SYSM_BUSOE				(MAC_SYSM_ADDR + 0xc)
#define MAC_SYSM_RMII				(MAC_SYSM_ADDR + 0x20)     
#define MAC_SYSM_FPGA0				(MAC_SYSM_ADDR + 0x28) 
#define MAC_SYSM_FPGA1				(MAC_SYSM_ADDR + 0x2c) 

#define MACConfig     	  		 	 (MAC_BASE_ADDR+0x00)
#define MACFrameFilter   		 	 (MAC_BASE_ADDR+0x04)
#define HashTableH	    			 (MAC_BASE_ADDR+0x08)
#define HashTableL	    			 (MAC_BASE_ADDR+0x0c)
#define GMIIAddr		     		 (MAC_BASE_ADDR+0x10)
#define GMIIData		     		 (MAC_BASE_ADDR+0x14)
#define FlowControl     			 (MAC_BASE_ADDR+0x18)
#define VLANTag			    		 (MAC_BASE_ADDR+0x1c)
                                                   
#define IdeftifiesVersion  	 		 (MAC_BASE_ADDR+0x20)
#define Reserved		   			 (MAC_BASE_ADDR+0x24)
#define RemoteWakeUp	   			 (MAC_BASE_ADDR+0x28)
#define PMTControl					 (MAC_BASE_ADDR+0x2c)
#define InterruptStatus   		 	 (MAC_BASE_ADDR+0x38)
#define InterruptMask     		 	 (MAC_BASE_ADDR+0x3c)
#define MACAddr0H     				 (MAC_BASE_ADDR+0x40)
#define MACAddr0L	    			 (MAC_BASE_ADDR+0x44)
#define MACAddr1H    				 (MAC_BASE_ADDR+0x48)
#define MACAddr1L     				 (MAC_BASE_ADDR+0x4c)
#define MACAddr2H					 (MAC_BASE_ADDR+0x50)
#define MACAddr2L 	    			 (MAC_BASE_ADDR+0x54)
#define MACAddr3H    				 (MAC_BASE_ADDR+0x58)
#define MACAddr3L					 (MAC_BASE_ADDR+0x5c)
#define MACAddr4H     				 (MAC_BASE_ADDR+0x60)
#define MACAddr4L 	    			 (MAC_BASE_ADDR+0x64)
#define MACAddr5H     				 (MAC_BASE_ADDR+0x68)
#define MACAddr5L 	    			 (MAC_BASE_ADDR+0x6C)
#define MACAddr6H     				 (MAC_BASE_ADDR+0x70)
#define MACAddr6L 	    			 (MAC_BASE_ADDR+0x74)
#define MACAddr7H     				 (MAC_BASE_ADDR+0x78)
#define MACAddr7L 	    			 (MAC_BASE_ADDR+0x7C)
#define MACAddr8H     				 (MAC_BASE_ADDR+0x80)
#define MACAddr8L 	    			 (MAC_BASE_ADDR+0x84)
#define MACAddr9H     				 (MAC_BASE_ADDR+0x88)
#define MACAddr9L 	    			 (MAC_BASE_ADDR+0x8C)
                                                     
#define MACAddr10H					 (MAC_BASE_ADDR+0x90)
#define MACAddr10L 	    		 	 (MAC_BASE_ADDR+0x94)
#define MACAddr11H					 (MAC_BASE_ADDR+0x98)
#define MACAddr11L 	    		 	 (MAC_BASE_ADDR+0x9C)
#define MACAddr12H		   			 (MAC_BASE_ADDR+0xA0)
#define MACAddr12L				 	 (MAC_BASE_ADDR+0xA4)
#define MACAddr13H					 (MAC_BASE_ADDR+0xA8)
#define MACAddr13L 	    		 	 (MAC_BASE_ADDR+0xAC)
#define MACAddr14H					 (MAC_BASE_ADDR+0xB0)
#define MACAddr14L 	    		 	 (MAC_BASE_ADDR+0xB4)
#define MACAddr15H					 (MAC_BASE_ADDR+0xB8)
#define MACAddr15L 	    		 	 (MAC_BASE_ADDR+0xBC)
                                                
#define ANControl 	    			 (MAC_BASE_ADDR+0xC0)
#define ANStatus		    		 (MAC_BASE_ADDR+0xC4)
#define ANAdvertise					 (MAC_BASE_ADDR+0xC8)
#define ANegoLink					 (MAC_BASE_ADDR+0xCC)
#define ANExpansion     		 	 (MAC_BASE_ADDR+0xD0)
#define TBIExStatus	    		 	 (MAC_BASE_ADDR+0xD4)
#define SGRGStatus	    			 (MAC_BASE_ADDR+0xD8)
                                               
#define TimeStampControl			 (MAC_BASE_ADDR+0x700)
#define SubSecIncrement				 (MAC_BASE_ADDR+0x704)
#define TimeStampHigh    		 	 (MAC_BASE_ADDR+0x708)
#define TimeStampLow  				 (MAC_BASE_ADDR+0x70C)
#define TimeStampHighUp 			 (MAC_BASE_ADDR+0x710)
#define TimeStampLowUp	     	  	 (MAC_BASE_ADDR+0x714)
#define TimeStampAddend				 (MAC_BASE_ADDR+0x718)
#define TargetTimeHigh	     	  	 (MAC_BASE_ADDR+0x71C)
#define TargetTimeLow	     		 (MAC_BASE_ADDR+0x720)
                                             
#define MACAddr16H	    			 (MAC_BASE_ADDR+0x800)
#define MACAddr16L					 (MAC_BASE_ADDR+0x804)
#define MACAddr17H    				 (MAC_BASE_ADDR+0x808)
#define MACAddr17L  				 (MAC_BASE_ADDR+0x80C)
#define MACAddr18H					 (MAC_BASE_ADDR+0x810)
#define MACAddr18L	    			 (MAC_BASE_ADDR+0x814)
#define MACAddr19H	    			 (MAC_BASE_ADDR+0x818)
#define MACAddr19L	    			 (MAC_BASE_ADDR+0x81C)
#define MACAddr20H	    			 (MAC_BASE_ADDR+0x820)
#define MACAddr20L	    			 (MAC_BASE_ADDR+0x824)
                         		                 
#define MACAddr21H	    			 (MAC_BASE_ADDR+0x828)
#define MACAddr21L					 (MAC_BASE_ADDR+0x82C)
#define MACAddr22H    				 (MAC_BASE_ADDR+0x830)
#define MACAddr22L  				 (MAC_BASE_ADDR+0x834)
#define MACAddr23H					 (MAC_BASE_ADDR+0x838)
#define MACAddr23L	    			 (MAC_BASE_ADDR+0x83C)
#define MACAddr24H	    			 (MAC_BASE_ADDR+0x840)
#define MACAddr24L	    			 (MAC_BASE_ADDR+0x844)
#define MACAddr25H	    			 (MAC_BASE_ADDR+0x848)
#define MACAddr25L	    			 (MAC_BASE_ADDR+0x84C)
                         		                     
#define MACAddr26H	    			 (MAC_BASE_ADDR+0x850)
#define MACAddr26L					 (MAC_BASE_ADDR+0x854)
#define MACAddr27H    				 (MAC_BASE_ADDR+0x858)
#define MACAddr27L  				 (MAC_BASE_ADDR+0x85C)
#define MACAddr28H					 (MAC_BASE_ADDR+0x860)
#define MACAddr28L	    			 (MAC_BASE_ADDR+0x864)
#define MACAddr29H	    			 (MAC_BASE_ADDR+0x868)
#define MACAddr29L	    			 (MAC_BASE_ADDR+0x86C)
#define MACAddr30H	    			 (MAC_BASE_ADDR+0x870)
#define MACAddr30L	    			 (MAC_BASE_ADDR+0x874)
#define MACAddr31H	    			 (MAC_BASE_ADDR+0x878)
#define MACAddr31L	    			 (MAC_BASE_ADDR+0x87C)


/* Ethernet DMA Registers */
#define BUSMODE     	       		 (MAC_BASE_ADDR+0x1000)
#define TxPollDemand      			 (MAC_BASE_ADDR+0x1004)
#define RxPollDemand     			 (MAC_BASE_ADDR+0x1008)
#define RxDescriptorListAddr   		 (MAC_BASE_ADDR+0x100c)
#define TxDescriptorListAddr   	 	 (MAC_BASE_ADDR+0x1010)
#define Status						 (MAC_BASE_ADDR+0x1014)
#define OperationMode    			 (MAC_BASE_ADDR+0x1018)
#define InterruptEnable   			 (MAC_BASE_ADDR+0x101c)
#define MissOverflow     			 (MAC_BASE_ADDR+0x1020)
#define CurrHostTxDescriptor   		 (MAC_BASE_ADDR+0x1048)
#define CurrHostRxDescriptor   	 	 (MAC_BASE_ADDR+0x104c)
#define CurrHostTxBufferAddr   	 	 (MAC_BASE_ADDR+0x1050)
#define CurrHostRxBufferAddr   	 	 (MAC_BASE_ADDR+0x1054)

...
/* XXX FOR IROM XXX */
#if 0
int mmc_vs_align(void) { return 512; }
...
int mmc0_vs_read(uint8_t *buf, loff_t start,
			int length, int x) { return mmc_bread(0, start >> 9, length >> 9, buf); }
int mmc1_vs_read(uint8_t *buf, loff_t start,
			int length, int x) { return mmc_bread(1, start >> 9, length >> 9, buf); }
int mmc2_vs_read(uint8_t *buf, loff_t start,
			int length, int x) { return mmc_bread(2, start >> 9, length >> 9, buf); }

int mmc0_vs_write(uint8_t *buf, loff_t start,
			int length, int x) { return mmc_bwrite(0, start >> 9, length >> 9, buf); }
int mmc1_vs_write(uint8_t *buf, loff_t start,
			int length, int x) { return mmc_bwrite(1, start >> 9, length >> 9, buf); }
int mmc2_vs_write(uint8_t *buf, loff_t start,
			int length, int x) { return mmc_bwrite(2, start >> 9, length >> 9, buf); }
#endif

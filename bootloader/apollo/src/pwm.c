...
void pwm_init(int pwmNo)
{
	...
	{
		case 1:
			*((volatile unsigned int *)(0x21e0906c+(86/8)*4)) &= 0<(86%8);//GPIO: function mode
			*((volatile unsigned int *)(0x21e0906c+(113/8)*4)) |=1<<(113%8);//GPIO function
		  	*((volatile unsigned int *)(0x21e0906c+(114/8)*4)) |=1<<(114%8);//GPIO function
			break;
		case 2:
			*((volatile unsigned int *)(0x21e0906c+(113/8)*4)) &= 0<(113%8);//GPIO: function mode
			*((volatile unsigned int *)(0x21e0906c+(86/8)*4)) |=1<<(86%8);//GPIO function
		  	*((volatile unsigned int *)(0x21e0906c+(114/8)*4)) |=1<<(114%8);//GPIO function
			break;
		case 3:
			*((volatile unsigned int *)(0x21e0906c+(114/8)*4)) &= 0<(114%8);//GPIO: function mode
			*((volatile unsigned int *)(0x21e0906c+(113/8)*4)) |=1<<(113%8);//GPIO function
		  	*((volatile unsigned int *)(0x21e0906c+(86/8)*4)) |=1<<(86%8);//GPIO function
			break;
	}

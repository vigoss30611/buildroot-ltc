...
#define ADDR_UMCTL2_PCCFG                  DWC_DDR_UMCTL_BASE_ADDR+0x400    //         Configuration Register
...
#define ADDR_UMCTL2_PCFGR_4                DWC_DDR_UMCTL_BASE_ADDR+0x614    //Port 4  Configuration Register
#define ADDR_UMCTL2_PCFGW_4                DWC_DDR_UMCTL_BASE_ADDR+0x618    //Port 4  Configuration Register
#define ADDR_UMCTL2_PCFGIDMASKCH0_4        DWC_DDR_UMCTL_BASE_ADDR+0x61C    //Port 4  Configuration Register
#define ADDR_UMCTL2_PCFGIDVALIDCH0_4       DWC_DDR_UMCTL_BASE_ADDR+0x620    //Port 4  Configuration Register
...
#define EMIF_SYSM_ADDR_CORE_GATE    (EMIF_SYSM_ADDR + 0x4)
#define	EMIF_SYSM_ADDR_BUS_RES		(EMIF_SYSM_ADDR + 0xc)
#define EMIF_SYSM_ADDR_BUS_GATE     (EMIF_SYSM_ADDR + 0x10)

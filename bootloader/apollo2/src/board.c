...
#else
int q3fpv10_bootst(void) {
	return 0;
}

int q3fpv10_binit(void) {
	return 0;
}

int q3fpv10_reset(void) {
	return 0;
}

int q3fpv10_shut(void) {
	return 0;
}

int q3fpv10_acon(void) {
	return 0;
}
...
void board_init_i2c(void)
{
	...
	return;
#else
	if(!item_exist("board.arch") || item_equal("board.arch", "q3fpv10", 0))
...
#if defined(CONFIG_IMAPX_FPGATEST)
	return q3f_fpga_bootst();
#else
	return q3fpv10_bootst();
#endif
}

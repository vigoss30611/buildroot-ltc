...
#else
int coronampwpv10_bootst(void) {
	return 0;
}

int coronampwpv10_binit(void) {
	return 0;
}

int coronampwpv10_reset(void) {
	return 0;
}

int coronampwpv10_shut(void) {
	return 0;
}

int coronampwpv10_acon(void) {
	return 0;
}
...
void board_init_i2c(void)
{
	...
	return;
#else
	if(!item_exist("board.arch") || item_equal("board.arch", "coronampwpv10", 0))
...
int board_shut(void) {
	...
	return 0;
#else
	return coronampwpv10_shut();
#endif
}

int board_bootst(void) {
#if defined(CONFIG_IMAPX_FPGATEST)
	return coronampw_fpga_bootst();
#else
	return coronampwpv10_bootst();
#endif
}

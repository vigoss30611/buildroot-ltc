...
extern int coronampw_fpga_binit(void);
extern int coronampw_fpga_reset(void);
extern int coronampw_fpga_shut(void);
extern int coronampw_fpga_bootst(void);
extern int coronampw_fpga_acon(void);
#endif
